...
class Auth {
     ...
     * @return void
     */
    function write($authRow, $regen = false, $loginType = 'form', $remember = '', $pathCookie = '/') {
        if ($regen) {
     ...
     * @return bool
     */
    function check($authRow, $pathCookie = '/') {
     ...
     * @return void
     */
    private function checkUser($authRow) {
