	<h3>所有栏目</h3>
	<p>
		点左侧菜单栏目管理，进入如下界面，可以对栏目进行编辑、删除、改变状态等操作。
	</p>
		...
		<div id="carousel_cate" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				<div class="item active">
					<img src="./zh_CN/help/image/cate_form_normal.jpg">
					<div class="carousel-caption indicator_black">普通栏目</div>
				</div>
				<div class="item">
					<img src="./zh_CN/help/image/cate_form_single.jpg">
					<div class="carousel-caption indicator_black">单页</div>
				</div>
				<div class="item">
					<img src="./zh_CN/help/image/cate_form_link.jpg">
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<p>栏目所使用的模板，模板添加、制作方法请参照 <a href="?lang=zh_CN&mod=tpl">模板文档</a>。也可以选择“继承上一级”，系统会根据上一级的模板生成页面，如当前栏目为一级栏目，则继承“系统设置”的有关选项。</p>
