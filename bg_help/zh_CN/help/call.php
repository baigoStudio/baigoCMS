	...
	<h3>创建（编辑）调用</h3>
	<p>
		点左侧子菜单的创建调用或者点击调用列表的编辑菜单，进入如下界面，在此，您可以对调用进行各项操作。
	</p>
		...
		<div id="carousel_call" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner" role="listbox">
				<div class="item active">
					<img src="./zh_CN/help/image/call_form_article.jpg">
					<div class="carousel-caption indicator_black">文章列表、排行</div>
				</div>
				<div class="item">
					<img src="./zh_CN/help/image/call_form_cate.jpg">
					<div class="carousel-caption indicator_black">栏目列表</div>
				</div>
				<div class="item">
					<img src="./zh_CN/help/image/call_form_tag.jpg">
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<p>按 文章管理 - 标记 的设定，显示隶属于这些标记的文章。仅在调用类型为文章列表时显示。<a href="?lang=zh_CN&mod=help&act=tag_mark#mark">标记</a> 详情。</p>

			<div class="alert alert-success">显示以下项目 <mark>以下选项因调用类型有所不同</mark></div>

			<h4 class="text-info">栏目名称</h4>
			<p>文章所隶属的栏目的名称。仅在调用类型为文章列表和栏目列表时显示。</p>

			<h4 class="text-info">文章标题</h4>
			<p>文章标题。仅在调用类型为文章列表时显示。</p>

			<h4 class="text-info">摘要</h4>
			<p>文章摘要。仅在调用类型为文章列表时显示。</p>

			<h4 class="text-info">TAG</h4>
			<p>文章 TAG 列表。仅在调用类型为文章列表时显示。</p>

			<h4 class="text-info">图片</h4>
			<p>可选不显示、原图、缩略图。仅在调用类型为文章列表时显示。</p>

			<h4 class="text-info">日期 / 时间</h4>
			<p>可选不显示、各种格式。仅在调用类型为文章列表时显示。</p>
			...
			<h4 class="text-info">应用 CSS 类名</h4>
			<p>将设定的 CSS 类名应用至最终显示结果。</p>
		</div>
	</div>
