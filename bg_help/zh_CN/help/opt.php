	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<p>允许上传的文件大小，超过此数值，系统将禁止上传，单位请参考下设置项；默认为 200 KB</p>
			...
			<p>此项用于附件的分发，如您的附件保存在同一台服务器上，可忽略此项目，并采用默认值，末尾请勿加 <mark>/</mark>。</p>

			<h4 class="text-info">分发 FTP 地址</h4>
			<p><mark>以下选项根据不同系统，有可能无相应选项。</mark>此项用于附件的分发，需要额外安装分发模块，如您想将附件保存在其他服务器上，需填写本项。详情请参考 <a href="#example">附件分发设置实例</a></p>
	...
	<h3>SSO 设置</h3>
	<p>
		点左侧子菜单SSO 设置，进入如下界面，可以对 SSO 设置进行设置。	baigo CMS 的用户以及后台登录需要 baigo SSO 支持，baigo SSO 的部署方式，请参照 <a href="http://www.baigo.net/Products/baigoSSO/" target="_blank">baigo SSO 官方网站</a>。
	</p>
