	...
	<h3>创建（编辑）文章</h3>
	<p>
		点左侧子菜单的创建文章或者点击文章列表的编辑菜单，进入如下界面，在此，您可以对文章进行各项操作。
	</p>
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<p>
				<img src="./zh_CN/help/image/article_tag.jpg" class="img-responsive">
			</p>
	...
	<h3>上传或插入</h3>
	<p>
		点上传或插入弹出如下对话框，在此您可以上传文件或选择已上传的文件，插入到文章中。
	</p>
	<p>
		点上传附件，可以选择文件，自动上传，上出完毕以后会自动插入到文章。上传受上传设置和附件类型的限制，详见 <a href="?lang=zh_CN&mod=help&act=opt#upfile">上传设置</a>、<a href="?lang=zh_CN&mod=help&act=attach#mime">附件类型</a>。
	</p>
	<p>
		点插入附件，可以浏览已上传的文件，鼠标移到缩略图上，会弹出菜单，选择插入原图或缩略图。<a href="?lang=zh_CN&mod=help&act=attach#thumb">缩略图</a> 详情。
	</p>
		...
		<div id="carousel_attach" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner" role="listbox">
				<div class="item active">
					<img src="./zh_CN/help/image/attach_form.jpg">
					<div class="carousel-caption">上传附件</div>
				</div>
				<div class="item">
					<img src="./zh_CN/help/image/attach_form_success.jpg">
					<div class="carousel-caption">上传附件成功</div>
				</div>
				<div class="item">
					<img src="./zh_CN/help/image/attach_insert.jpg">
