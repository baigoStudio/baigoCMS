		...
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="./">
					<img alt="baigo CMS" src="./image/logo_baigo_cms.png">
				</a>
			</div>
			<nav class="collapse navbar-collapse bs-navbar-collapse">
				<ul class="nav navbar-nav navbar-right">
					<li<?php if ($_str_mod == "intro") { ?> class="active"<?php } ?>><a href="./?lang=zh_CN">简介</a></li>
					<li<?php if ($_str_mod == "install") { ?> class="active"<?php } ?>><a href="./?lang=zh_CN&mod=install">安装</a></li>
					...
					<li><a href="http://www.baigo.net/Products/baigoCMS/?lang=zh_CN&mod=download" target="_blank">下载</a></li>
				</ul>
			</nav>
		</div>
	</header>
