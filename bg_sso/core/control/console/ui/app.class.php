    ...
    */
    function ctrl_form() {
        ...
        if ($_num_appId > 0) {
            ...
            $_arr_statusKeys   = array_keys($this->obj_tpl->status["app"]);
            $_arr_syncKeys     = array_keys($this->obj_tpl->status["appSync"]);
            ...
            $_arr_appRow = array(
                ...
                "app_ip_bad"        => "",
                "app_note"          => "",
                "app_status"        => $_arr_statusKeys[0],
                "app_sync"          => $_arr_syncKeys[0],
            );
        }
