...
class MODEL_USER_PROFILE extends MODEL_USER {
    ...
    function input_qa() {
        ...
        for ($_iii = 1; $_iii <= 3; $_iii++) {
            $_arr_userSecQues = validateStr(fn_post("user_sec_ques_" . $_iii), 1, 0);
            ...
            $_arr_userSecAnsw = validateStr(fn_post("user_sec_answ_" . $_iii), 1, 0);
    ...
    function input_token($str_method = "get") {
        ...
        $_arr_refreshToken = validateStr($_str_refreshToken, 1, 32);
