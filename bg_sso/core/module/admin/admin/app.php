...
include_once(BG_PATH_CONTROL_ADMIN . "admin/app.class.php"); //载入商家控制器
...
switch ($act_get) {
	case "show":
		...
		if ($arr_appRow["str_alert"] != "y050102") {
			header("Location: " . BG_URL_ADMIN . "admin.php?mod=alert&act_get=display&alert=" . $arr_appRow["str_alert"]);
			exit;
		}
	break;
