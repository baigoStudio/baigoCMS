                ...
                <div class="panel panel-success">
                    <div class="list-group">
                        {foreach $adminMod as $key_m=>$value_m}
                            <a href="{$smarty.const.BG_URL_ADMIN}ctl.php?mod={$value_m.main.mod}" class="list-group-item{if isset($cfg.menu_active) && $cfg.menu_active == $key_m} list-group-item-success active{/if}">
