...
$cfg = array(
    "title"          => $this->consoleMod["app"]["main"]["title"] . " &raquo; " . $title_sub,
    "menu_active"    => "app",
    "sub_active"     => $str_sub,
    "baigoCheckall"  => "true",
    "baigoValidator" => "true",
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <div id="group_app_name">
                                <label class="control-label"><?php echo $this->lang["label"]["appName"]; ?><span id="msg_app_name">*</span></label>
                        ...
                        <div class="form-group">
                            <div id="group_app_url_notify">
                                <label class="control-label"><?php echo $this->lang["label"]["appUrlNotify"]; ?><span id="msg_app_url_notify">*</span></label>
                        ...
                        <div class="form-group">
                            <div id="group_app_url_sync">
                                <label class="control-label"><?php echo $this->lang["label"]["appUrlSync"]; ?><span id="msg_app_url_sync">*</span></label>
                        ...
                        <div class="form-group">
                            <label class="control-label"><?php echo $this->lang["label"]["allow"]; ?><span id="msg_app_allow">*</span></label>
                            <dl class="bg-dl">
                                <dd>
                        ...
                        <div class="form-group">
                            <div id="group_app_ip_allow">
                                <label class="control-label"><?php echo $this->lang["label"]["ipAllow"]; ?><span id="msg_app_ip_allow"></span></label>
                            ...
                            <span class="help-block"><?php echo $this->lang["label"]["ipNote"]; ?></span>
                        </div>

                        <div class="form-group">
                            <div id="group_app_ip_bad">
                                <label class="control-label"><?php echo $this->lang["label"]["ipBad"]; ?><span id="msg_app_ip_bad"></span></label>
                        ...
                        <div class="form-group">
                            <div id="group_app_note">
                                <label class="control-label"><?php echo $this->lang["label"]["note"]; ?><span id="msg_app_note"></span></label>
                ...
                <div class="well">
                    ...
                    <div class="form-group">
                        <div id="group_app_status">
                            <label class="control-label"><?php echo $this->lang["label"]["status"]; ?><span id="msg_app_status">*</span></label>
                            <?php foreach ($this->status["app"] as $key=>$value) { ?>
                                <div class="bg-radio">
                                    <label for="app_status_<?php echo $key; ?>">
                                        <input type="radio" name="app_status" id="app_status_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php if ($this->tplData["appRow"]["app_status"] == $key) { ?>checked<?php } ?> data-validate="app_status">
                                        <?php echo $value; ?>
                                    </label>
                                </div>
                            <?php } ?>
                    ...
                    <div class="form-group">
                        <div id="group_app_sync">
                            <label class="control-label"><?php echo $this->lang["label"]["sync"]; ?><span id="msg_app_sync">*</span></label>
                            <?php foreach ($this->status["appSync"] as $key=>$value) { ?>
                                <div class="bg-radio">
                                    <label for="app_sync_<?php echo $key; ?>">
                                        <input type="radio" name="app_sync" id="app_sync_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php if ($this->tplData["appRow"]["app_sync"] == $key) { ?>checked<?php } ?> data-validate="app_sync">
                                        <?php echo $value; ?>
                                    </label>
                                </div>
                            <?php } ?>
...
<?php include($cfg["pathInclude"] . "console_foot.php"); ?>
    ...
    var opts_validator_form = {
        app_name: {
            ...
            msg: { selector: "#msg_app_name", too_short: "<?php echo $this->rcode["x050201"]; ?>", too_long: "<?php echo $this->rcode["x050202"]; ?>" }
        },
        app_url_notify: {
            len: { min: 1, max: 3000 },
            validate: { type: "str", format: "url", group: "#group_app_url_notify" },
            msg: { selector: "#msg_app_url_notify", too_short: "<?php echo $this->rcode["x050207"]; ?>", too_long: "<?php echo $this->rcode["x050208"]; ?>", format_err: "<?php echo $this->rcode["x050209"]; ?>" }
        },
        app_url_sync: {
            len: { min: 1, max: 3000 },
            validate: { type: "str", format: "url", group: "#group_app_url_sync" },
            msg: { selector: "#msg_app_url_sync", too_short: "<?php echo $this->rcode["x050219"]; ?>", too_long: "<?php echo $this->rcode["x050220"]; ?>", format_err: "<?php echo $this->rcode["x050221"]; ?>" }
        },
        app_ip_allow: {
            len: { min: 0, max: 3000 },
            validate: { type: "str", format: "text", group: "#group_app_ip_allow" },
            msg: { selector: "#msg_app_ip_allow", too_long: "<?php echo $this->rcode["x050210"]; ?>" }
        },
        app_ip_bad: {
            len: { min: 0, max: 3000 },
            validate: { type: "str", format: "text", group: "#group_app_ip_bad" },
            msg: { selector: "#msg_app_ip_bad", too_long: "<?php echo $this->rcode["x050211"]; ?>" }
        },
        app_note: {
            len: { min: 0, max: 30 },
            validate: { type: "str", format: "text", group: "#group_app_note" },
            msg: { selector: "#msg_app_note", too_long: "<?php echo $this->rcode["x050205"]; ?>" }
        },
        app_status: {
            len: { min: 1, max: 0 },
            validate: { selector: "[name='app_status']", type: "radio", group: "#group_app_status" },
            msg: { selector: "#msg_app_status", too_few: "<?php echo $this->rcode["x050206"]; ?>" }
        },
        app_sync: {
            len: { min: 1, max: 0 },
            validate: { selector: "[name='app_sync']", type: "radio", group: "#group_app_sync" },
            msg: { selector: "#msg_app_sync", too_few: "<?php echo $this->rcode["x050218"]; ?>" }
        }
    };
