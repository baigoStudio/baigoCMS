...
include($cfg["pathInclude"] . "setup_head.php"); ?>
    ...
    <form name="setup_form_admin" id="setup_form_admin">
        ...
        <div class="form-group clearfix">
            <div class="pull-left">
                <div class="btn-group">
                    <a href="<?php echo BG_URL_INSTALL; ?>index.php?mod=setup&act=smtp" class="btn btn-default"><?php echo $this->lang["btn"]["stepPrev"]; ?></a>
...
<?php include($cfg["pathInclude"] . "install_foot.php"); ?>
    ...
    var opts_validator_form = {
        admin_name: {
            ...
            msg: { selector: "#msg_admin_name", too_short: "<?php echo $this->rcode["x010201"]; ?>", too_long: "<?php echo $this->rcode["x020202"]; ?>", format_err: "<?php echo $this->rcode["x020203"]; ?>", ajaxIng: "<?php echo $this->rcode["x030401"]; ?>", ajax_err: "<?php echo $this->rcode["x030402"]; ?>" },
        ...
        admin_pass: {
            ...
            msg: { selector: "#msg_admin_pass", too_short: "<?php echo $this->rcode["x010224"]; ?>" }
        },
        admin_pass_confirm: {
            len: { min: 1, max: 0 },
        ...
        admin_nick: {
            ...
            msg: { selector: "#msg_admin_nick", too_short: "<?php echo $this->rcode["x020204"]; ?>" }
        }
    };
