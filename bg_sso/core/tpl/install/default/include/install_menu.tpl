    <ul class="dropdown-menu">
        ...
        {foreach $opt as $key_opt=>$value_opt}
            <li{if isset($tplData.act_get) && $tplData.act_get == $key_opt} class="active"{/if}><a href="{$smarty.const.BG_URL_INSTALL}ctl.php?mod=install&act_get={$key_opt}">{$value_opt.title}</a>
            </li>
        {/foreach}
