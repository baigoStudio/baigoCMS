...
define('BG_MODULE_GATHER', 0);
define('BG_DEFAULT_SESSION', 1200);
define('BG_DEFAULT_REMENBER', 3600 * 24 * 30);
...
define('BG_PATH_CALL', BG_PATH_CONTENT . BG_NAME_CALL . DS);
...
define('BG_URL_CONTENT', BG_URL_ROOT . BG_NAME_CONTENT . '/');
define('BG_URL_CALL', BG_URL_CONTENT . BG_NAME_CALL . '/');
