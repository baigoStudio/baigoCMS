...
class MODEL_SPEC_BELONG {
    ...
    function mdl_create_index() {
        ...
        $_num_db = $this->obj_db->create_index('search_article', BG_DB_TABLE . 'spec_belong', $_arr_specBelongIndex, 'BTREE', $is_exists);
        ...
        $_num_db = $this->obj_db->create_index('search_spec', BG_DB_TABLE . 'spec_belong', $_arr_specBelongIndex, 'BTREE', $is_exists);
