...
class MODEL_SPEC {
    ...
    function input_submit() {
        ...
        $_arr_specName = fn_validate(fn_post('spec_name'), 1, 300);
        ...
        $_arr_specStatus = fn_validate(fn_post('spec_status'), 1, 0);
        ...
        $this->specInput['spec_content'] = fn_htmlcode(fn_safe(fn_post('spec_content')), 'decode');
    ...
    private function url_process($_arr_specRow) {
        ...
        switch (BG_VISIT_TYPE) {
            case 'static':
                $_str_specPath      = BG_PATH_ROOT . 'focus' . DS . $_arr_specRow['spec_id'] . DS;
