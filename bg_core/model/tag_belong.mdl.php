...
class MODEL_TAG_BELONG {
    ...
    function mdl_create_index() {
        ...
        $_arr_indexRow    = $this->obj_db->show_indexs(BG_DB_TABLE . 'tag_belong');
        ...
        $_num_db = $this->obj_db->create_index('search_article', BG_DB_TABLE . 'tag_belong', $_arr_tagBelongIndex, 'BTREE', $drop_overlap);
        ...
        $_num_db = $this->obj_db->create_index('search_tag', BG_DB_TABLE . 'tag_belong', $_arr_tagBelongIndex, 'BTREE', $drop_overlap);
