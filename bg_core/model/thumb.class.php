    ...
    */
    ...
    function mdl_cache($is_reGen = false) {
        if ($is_reGen || !file_exists(BG_PATH_CACHE . 'sys' . DS . 'thumb_list.json')) {
            ...
            $_num_size = $this->obj_dir->put_file(BG_PATH_CACHE . 'sys' . DS . 'thumb_list.json', $_str_outPut);
        }

        $_str_cacheReturn = file_get_contents(BG_PATH_CACHE . 'sys' . DS . 'thumb_list.json');
