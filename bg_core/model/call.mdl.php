...
class MODEL_CALL {
    ...
    function mdl_read($num_callId, $is_min = false) {
        ...
        if (isset($_arr_callRow['call_amount'])) {
            $_arr_callRow['call_amount']      = fn_jsonDecode($_arr_callRow['call_amount']); //json解码
        } else {
        ...
        if (isset($_arr_callRow['call_cate_ids'])) {
            $_arr_callRow['call_cate_ids'] = fn_jsonDecode($_arr_callRow['call_cate_ids']); //json解码
        } else {
            $_arr_callRow['call_cate_ids'] = array();
        }

        if (isset($_arr_callRow['call_cate_excepts'])) {
            $_arr_callRow['call_cate_excepts'] = fn_jsonDecode($_arr_callRow['call_cate_excepts']); //json解码
        } else {
            $_arr_callRow['call_cate_excepts'] = array();
        }

        if (isset($_arr_callRow['call_mark_ids'])) {
            $_arr_callRow['call_mark_ids'] = fn_jsonDecode($_arr_callRow['call_mark_ids']); //json解码
        } else {
            $_arr_callRow['call_mark_ids'] = array();
        }

        if (isset($_arr_callRow['call_spec_ids'])) {
            $_arr_callRow['call_spec_ids'] = fn_jsonDecode($_arr_callRow['call_spec_ids']); //json解码
        } else {
    ...
    function input_submit() {
        ...
        $this->callInput = fn_post(false, $_arr_inputParam);

        $this->callInput['call_id'] = fn_getSafe($this->callInput['call_id'], 'int', 0);
        ...
        $_arr_callName = fn_validate($this->callInput['call_name'], 1, 300);
        ...
        $_arr_callType = fn_validate($this->callInput['call_type'], 1, 0);
        ...
        $_arr_callStatus = fn_validate($this->callInput['call_status'], 1, 0);
        ...
        $this->callInput['call_file']            = fn_getSafe($this->callInput['call_file'], 'txt', '');
        $this->callInput['call_tpl']             = fn_getSafe($this->callInput['call_tpl'], 'txt', '');
        ...
        $this->callInput['call_attach']          = fn_getSafe($this->callInput['call_attach'], 'txt', '');
        $this->callInput['call_cate_id']         = fn_getSafe($this->callInput['call_cate_id'], 'int', 0);

        $this->callInput['call_spec_ids']        = fn_jsonEncode($this->callInput['call_spec_ids']);
        $this->callInput['call_cate_ids']        = fn_jsonEncode($this->callInput['call_cate_ids']);
        $this->callInput['call_cate_excepts']    = fn_jsonEncode($this->callInput['call_cate_excepts']);
        $this->callInput['call_mark_ids']        = fn_jsonEncode($this->callInput['call_mark_ids']);
        $this->callInput['call_amount']          = fn_jsonEncode($this->callInput['call_amount']);
    ...
    private function url_process($arr_callRow) {
        ...
        if (BG_VISIT_TYPE == 'static') {
            $_str_callPath      = BG_PATH_CALL;
            $_str_callPathShort = '/bg_content/call/' . $arr_callRow['call_id'] . '.' . $arr_callRow['call_file'];
            $_str_callUrl       = BG_URL_CALL . $arr_callRow['call_id'] . '.' . $arr_callRow['call_file'];
