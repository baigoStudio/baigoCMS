...
class MODEL_ADMIN {
    ...
    function mdl_create_table() {
        ...
        $_arr_adminCreate = array(
            ...
            'admin_group_id'        => 'smallint NOT NULL COMMENT \'群组 ID\'',
    ...
    function mdl_alter_table() {
        ...
        if (!in_array('admin_allow_profile', $_arr_col)) {
            $_arr_alter['admin_allow_profile'] = array('ADD', 'varchar(1000) NOT NULL COMMENT \'个人权限\'');
        }
        ...
        if (in_array('admin_group_id', $_arr_col)) {
            $_arr_alter['admin_group_id'] = array('CHANGE', 'smallint NOT NULL COMMENT \'群组 ID\'', 'admin_group_id');
        }
        ...
        if (in_array('admin_ip', $_arr_col)) {
            $_arr_alter['admin_ip'] = array('CHANGE', 'char(15) NOT NULL COMMENT \'IP\'', 'admin_ip');
        }

        if (in_array('admin_allow_cate', $_arr_col)) {
            $_arr_alter['admin_allow_cate'] = array('CHANGE', 'text NOT NULL COMMENT \'栏目权限\'', 'admin_allow_cate');
        }
    ...
    function mdl_submit($num_adminId) {
        ...
        $_arr_adminData = array(
            ...
            'admin_allow_cate'      => $this->adminInput['admin_allow_cate'],
    ...
    function mdl_read($num_adminId) {
        ...
        if (fn_isEmpty($_arr_adminRow['admin_allow_cate'])) {
            ...
            $_arr_adminRow['admin_allow_cate']    = fn_jsonDecode($_arr_adminRow['admin_allow_cate']); //json解码
        }
    ...
    function input_submit() {
        ...
        $this->adminInput['admin_allow_cate']      = fn_jsonEncode(fn_post('admin_allow_cate'));
    ...
    function input_login() {
        ...
        $_arr_adminLogin['admin_remenber'] = fn_getSafe(fn_post('admin_remenber'), 'txt', '');

        $_arr_adminLogin['rcode'] = 'ok';
