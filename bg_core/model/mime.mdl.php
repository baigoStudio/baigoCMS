...
class MODEL_MIME {
    ...
    */
    function mdl_read($str_mime, $str_readBy = 'mime_id', $num_notId = 0) {
        ...
        $_arr_mimeRow['mime_content'] = fn_jsonDecode($_arr_mimeRow['mime_content']); //json解码
    ...
    */
    function mdl_list($num_no, $num_except = 0) {
        ...
        foreach ($_arr_mimeRows as $_key=>$_value) {
            $_arr_mimeRows[$_key]['mime_content'] = fn_jsonDecode($_value['mime_content']);
        }
    ...
    */
    ...
    function input_submit() {
        ...
        $this->mimeInput = fn_post(false, $_arr_inputParam);

        $this->mimeInput['mime_id'] = fn_getSafe($this->mimeInput['mime_id'], 'int', 0);
        ...
        $_arr_mimeExt = fn_validate($this->mimeInput['mime_ext'], 1, 30);
        ...
        $_arr_mimeNote = fn_validate($this->mimeInput['mime_note'], 0, 300);
        ...
        $this->mimeInput['mime_content']    = fn_jsonEncode($this->mimeInput['mime_content']);
