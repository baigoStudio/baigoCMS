...
class MODEL_MARK {
    ...
    function mdl_create_table() {
        ...
        $_num_db = $this->obj_db->create_table(BG_DB_TABLE . 'mark', $_arr_markCreat, 'mark_id', '标记');
    ...
    function mdl_submit() {
        ...
        if ($this->markInput['mark_id'] < 1) {
            ...
            $_num_db  = $this->obj_db->update(BG_DB_TABLE . 'mark', $_arr_markData, '`mark_id`=' . $_num_markId);
    ...
    function mdl_del() {
        ...
        $_num_db = $this->obj_db->delete(BG_DB_TABLE . 'mark',  '`mark_id` IN (' . $_str_markIds . ')'); //删除数据
    ...
    function input_submit() {
        ...
        $_arr_markName = fn_validate(fn_post('mark_name'), 1, 30);
    ...
    function input_ids() {
        ...
        $this->markIds = array(
            'rcode'     => $_str_rcode,
            'mark_ids'  => array_filter(array_unique($_arr_markIds)),
        );
