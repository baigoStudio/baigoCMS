...
class MODEL_GSITE {
    ...
    function mdl_read($str_gsite, $str_readBy = 'gsite_id', $is_min = false) {
        ...
        $_arr_gsiteRow['gsite_attr_except']             = fn_jsonDecode($_arr_gsiteRow['gsite_attr_except']);

        $_arr_gsiteRow['gsite_title_replace']           = fn_jsonDecode($_arr_gsiteRow['gsite_title_replace'], true);
        $_arr_gsiteRow['gsite_content_replace']         = fn_jsonDecode($_arr_gsiteRow['gsite_content_replace'], true);
        $_arr_gsiteRow['gsite_time_replace']            = fn_jsonDecode($_arr_gsiteRow['gsite_time_replace'], true);
        $_arr_gsiteRow['gsite_source_replace']          = fn_jsonDecode($_arr_gsiteRow['gsite_source_replace'], true);
        $_arr_gsiteRow['gsite_author_replace']          = fn_jsonDecode($_arr_gsiteRow['gsite_author_replace'], true);
        $_arr_gsiteRow['gsite_page_content_replace']    = fn_jsonDecode($_arr_gsiteRow['gsite_page_content_replace'], true);
