...
class MODEL_GSITE_STEP extends MODEL_GSITE {
    ...
    function input_step_page_content() {
        ...
        $this->inputStepPageContent['gsite_page_content_replace'] = fn_jsonEncode(fn_post('gsite_page_content_replace'), 'encode');
    ...
    function input_step_content() {
        ...
        $this->inputStepContent['gsite_title_replace'] = fn_jsonEncode(fn_post('gsite_title_replace'), 'encode');
        ...
        $this->inputStepContent['gsite_content_replace'] = fn_jsonEncode(fn_post('gsite_content_replace'), 'encode');
        ...
        $this->inputStepContent['gsite_time_replace'] = fn_jsonEncode(fn_post('gsite_time_replace'), 'encode');
        ...
        $this->inputStepContent['gsite_source_replace'] = fn_jsonEncode(fn_post('gsite_source_replace'), 'encode');
        ...
        $this->inputStepContent['gsite_author_replace'] = fn_jsonEncode(fn_post('gsite_author_replace'), 'encode');
        ...
        $this->inputStepContent['gsite_attr_except'] = fn_jsonEncode(fn_post('gsite_attr_except'), 'no');
