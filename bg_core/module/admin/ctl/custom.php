...
include_once(BG_PATH_CONTROL . "admin/ctl/custom.class.php"); //载入模板类

$ctl_custom = new CONTROL_CUSTOM(); //初始化设置对象

switch ($GLOBALS["act_get"]) {
    case "form":
        $arr_customRow = $ctl_custom->ctl_form();
    ...
    case "order":
        ...
        if ($arr_customRow["alert"] != "y200102") {
            header("Location: " . BG_URL_ADMIN . "ctl.php?mod=alert&act_get=show&alert=" . $arr_customRow["alert"] . $_url_attach);
            exit;
        }
    break;
