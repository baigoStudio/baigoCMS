...
include_once(BG_PATH_CONTROL_ADMIN . "admin/mark.class.php"); //载入模板类
...
switch ($act_get) {
	default:
		...
		if ($arr_markRow["str_alert"] != "y140301") {
			header("Location: " . BG_URL_ADMIN . "admin.php?mod=alert&act_get=display&alert=" . $arr_markRow["str_alert"]);
			exit;
		}
	break;
}
