...
include_once(BG_PATH_CONTROL_ADMIN . "admin/group.class.php"); //载入模板类
...
switch ($act_get) {
	case "show":
		...
		if ($arr_groupRow["str_alert"] != "y040102") {
			header("Location: " . BG_URL_ADMIN . "admin.php?mod=alert&act_get=display&alert=" . $arr_groupRow["str_alert"]);
			exit;
		}
	break;
