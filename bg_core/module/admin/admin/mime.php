...
include_once(BG_PATH_CONTROL_ADMIN . "admin/mime.class.php"); //载入模板类
...
switch ($act_get) {
	default:
		...
		if ($arr_mimeRow["str_alert"] != "y080301") {
			header("Location: " . BG_URL_ADMIN . "admin.php?mod=alert&act_get=display&alert=" . $arr_mimeRow["str_alert"]);
			exit;
		}
	break;
}
