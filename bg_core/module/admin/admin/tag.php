...
include_once(BG_PATH_CONTROL_ADMIN . "admin/tag.class.php"); //载入模板类
...
switch ($act_get) {
	default:
		...
		if ($arr_tagRow["str_alert"] != "y130301") {
			header("Location: " . BG_URL_ADMIN . "admin.php?mod=alert&act_get=display&alert=" . $arr_tagRow["str_alert"]);
			exit;
		}
	break;
}
