...
include_once(BG_PATH_CONTROL_ADMIN . "admin/cate.class.php"); //载入设置类
...
switch ($act_get) {
	case "order":
		...
		if ($arr_cateRow["str_alert"] != "y110102") {
			header("Location: " . BG_URL_ADMIN . "admin.php?mod=alert&act_get=display&alert=" . $arr_cateRow["str_alert"]);
			exit;
		}
	break;
