...
class CONTROL_CONSOLE_REQUEST_SPEC_GEN {
    ...
    private function output_process($arr_specRow, $arr_page) {
        ...
        $_arr_pluginReturn = $GLOBALS['obj_plugin']->trigger('filter_gen_spec_show', $_arr_tplData); //编辑文章时触发
        if (isset($_arr_pluginReturn['filter_gen_spec_show'])) {
            $_arr_pluginReturnDo    = $_arr_pluginReturn['filter_gen_spec_show'];
        ...
        $_num_size      = $this->obj_file->file_put($arr_specRow['urlRow']['spec_path'] . $arr_specRow['urlRow']['page_attach'] . $arr_page['page'] . $arr_specRow['urlRow']['page_ext'], $_str_outPut);
        ...
        $this->obj_file->file_copy($arr_specRow['urlRow']['spec_path'] . $arr_specRow['urlRow']['page_attach'] . '1' . $arr_specRow['urlRow']['page_ext'], $arr_specRow['urlRow']['spec_path'] . 'index' . $arr_specRow['urlRow']['page_ext']);
        ...
        if (BG_MODULE_FTP > 0 && defined('BG_SPEC_FTPHOST') && !fn_isEmpty(BG_SPEC_FTPHOST)) {
            ...
            $_ftp_status = $this->obj_ftp->file_upload($arr_specRow['urlRow']['spec_path'] . $arr_specRow['urlRow']['page_attach'] . $arr_page['page'] . $arr_specRow['urlRow']['page_ext'], BG_SPEC_FTPPATH . $arr_specRow['urlRow']['spec_pathShort'] . $arr_specRow['urlRow']['page_attach'] . $arr_page['page'] . $arr_specRow['urlRow']['page_ext']);

            $_ftp_status = $this->obj_ftp->file_upload($arr_specRow['urlRow']['spec_path'] . 'index' . $arr_specRow['urlRow']['page_ext'], BG_SPEC_FTPPATH . $arr_specRow['urlRow']['spec_pathShort'] . 'index' . $arr_specRow['urlRow']['page_ext']);
        }
    }
    ...
    private function list_process($arr_page, $arr_search) {
        ...
        $_arr_pluginReturn = $GLOBALS['obj_plugin']->trigger('filter_gen_spec_list', $_arr_tplData); //编辑文章时触发
        if (isset($_arr_pluginReturn['filter_gen_spec_list'])) {
            $_arr_pluginReturnDo    = $_arr_pluginReturn['filter_gen_spec_list'];
        ...
        $_num_size      = $this->obj_file->file_put($this->urlRow['spec_path'] . $this->urlRow['page_attach'] . $arr_page['page'] . $this->urlRow['page_ext'], $_str_outPut);
        ...
        $this->obj_file->file_copy($this->urlRow['spec_path'] . $this->urlRow['page_attach'] . '1' . $this->urlRow['page_ext'], $this->urlRow['spec_path'] . 'index' . $this->urlRow['page_ext']);
        ...
        if (BG_MODULE_FTP > 0 && defined('BG_SPEC_FTPHOST') && !fn_isEmpty(BG_SPEC_FTPHOST)) {
            ...
            $_ftp_status = $this->obj_ftp->file_upload($this->urlRow['spec_path'] . $this->urlRow['page_attach'] . $arr_page['page'] . $this->urlRow['page_ext'], BG_SPEC_FTPPATH . $this->urlRow['spec_pathShort'] . $this->urlRow['page_attach'] . $arr_page['page'] . $this->urlRow['page_ext']);

            $_ftp_status = $this->obj_ftp->file_upload($this->urlRow['spec_path'] . 'index' . $this->urlRow['page_ext'], BG_SPEC_FTPPATH . $this->urlRow['spec_pathShort'] . 'index' . $this->urlRow['page_ext']);
        }
    }
}
