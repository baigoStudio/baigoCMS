...
class CONTROL_CONSOLE_UI_GROUP {
    ...
    function ctrl_form() {
        ...
        if ($_num_groupId > 0) {
            ...
            $_arr_statusKeys   = array_keys($this->obj_tpl->status["group"]);
            $_arr_typeKeys     = array_keys($this->obj_tpl->type["group"]);

            $_arr_groupRow = array(
                "group_id"      => 0,
                "group_name"    => "",
                "group_note"    => "",
                "group_type"    => $_arr_typeKeys[0],
                "group_status"  => $_arr_statusKeys[0],
                "group_allow"   => array(),
            );
        }
