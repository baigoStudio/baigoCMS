...
class CONTROL_CONSOLE_UI_GATHER {
    ...
    function ctrl_1by1() {
        ...
        $_str_jump = BG_URL_CONSOLE . 'index.php?m=gather&a=1by1&min_id=' . $_arr_gsiteRow['gsite_id'] . '&view=iframe';
    ...
    function ctrl_store() {
        ...
        $_str_jump = BG_URL_CONSOLE . 'index.php?m=gather&a=' . $GLOBALS['route']['bg_act'] . '&page=' . ($_arr_page['page'] + 1) . '&view=iframe' . $_str_ids . '&enforce=' . $_bool_enforce;
