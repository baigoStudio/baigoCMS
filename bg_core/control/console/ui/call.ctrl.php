...
class CONTROL_CONSOLE_UI_CALL {
    ...
    function __construct() { //构造函数
        ...
        $this->tplData = array(
            ...
            'status'        => $this->mdl_call->arr_status,
            'type'          => $this->mdl_call->arr_type,
            'file'          => $this->mdl_call->arr_file,
            'attach'        => $this->mdl_call->arr_attach,
        );
    }
    ...
    function ctrl_form() {
        ...
        $_arr_tplRows     = $this->obj_file->dir_list(BG_PATH_TPL . 'call/');
