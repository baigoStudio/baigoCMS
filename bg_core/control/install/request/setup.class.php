...
class CONTROL_INSTALL_REQUEST_SETUP {
    ...
    function ctrl_admin() {
        ...
        $_arr_ssoReg = $_obj_sso->sso_user_reg($_arr_userSubmit);
        if ($_arr_ssoReg['rcode'] != 'y010101' && $_arr_ssoReg['rcode'] != 'y010410' && $_arr_ssoReg['rcode'] != 'x010410') {
    ...
    function ctrl_ssoAdmin() {
        ...
        $_arr_tplData = $_mdl_admin->mdl_submit($_arr_ssoAdmin['user_id']);
