...
class GEN_SPEC {
    ...
    function gen_list() {
        ...
        $this->obj_tpl->tplDisplay("genSpec_list.tpl", $_arr_tplData);
    ...
    function gen_single() {
        ...
        $this->obj_tpl->tplDisplay("genSpec_single.tpl", $_arr_tplData);
    ...
    function gen_1by1() {
        ...
        if ($_num_maxId > 0 && $_num_maxId <= $_num_minId) {
            ...
            $_arr_specRow = $this->mdl_spec->mdl_read($_num_maxId, "spec_id", 0, true);
            if ($_arr_specRow["alert"] != "y180102") {
                $_str_status = "complete";
            } else {
                if ($_arr_specRow["spec_status"] != "show") {
        ...
        $this->obj_tpl->tplDisplay("genSpec_1by1.tpl", $_arr_tplData);
    ...
    private function output_process($arr_specRow, $arr_page) {
        ...
        $_str_outPut    = $_obj_tpl->tplDisplay("spec_show.tpl", $_arr_tplData, false);
    ...
    private function list_process($arr_page, $arr_search) {
        ...
        $_str_outPut = $_obj_tpl->tplDisplay("spec_list.tpl", $_arr_tplData, false);
