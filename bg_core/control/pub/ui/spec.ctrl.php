...
class CONTROL_PUB_UI_SPEC {
    ...
    function ctrl_show() {
        ...
        $_arr_pluginReturn = $GLOBALS['obj_plugin']->trigger('filter_pub_spec_show', $_arr_tplData); //编辑文章时触发
        if (isset($_arr_pluginReturn['filter_pub_spec_show'])) {
            $_arr_pluginReturnDo    = $_arr_pluginReturn['filter_pub_spec_show'];
    ...
    function ctrl_list() {
        ...
        $_arr_pluginReturn = $GLOBALS['obj_plugin']->trigger('filter_pub_spec_list', $_arr_tplData); //编辑文章时触发
        if (isset($_arr_pluginReturn['filter_pub_spec_list'])) {
            $_arr_pluginReturnDo    = $_arr_pluginReturn['filter_pub_spec_list'];
