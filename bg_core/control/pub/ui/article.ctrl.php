...
class CONTROL_PUB_UI_ARTICLE {
    ...
    function ctrl_show() {
        ...
        $_arr_pluginReturn = $GLOBALS['obj_plugin']->trigger('filter_pub_article_show', $_arr_tpl); //编辑文章时触发
        if (isset($_arr_pluginReturn['filter_pub_article_show'])) {
            $_arr_pluginReturnDo    = $_arr_pluginReturn['filter_pub_article_show'];
