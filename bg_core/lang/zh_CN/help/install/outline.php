<?php
return "<h3>概述</h3>
	<p>将下载到的程序包解压，然后将所有文件上传到服务器，假设首页 URL 为 <span class=\"text-primary\">http://www.domain.com</span> 上传到根目录 <mark>/</mark>，以下说明均以此为例。</p>
		...
		<div class=\"table-responsive\">
			<table class=\"table\">
				...
				<tbody>
					...
					<tr>
						<td class=\"text-nowrap\">bg_sso</td>
						<td class=\"text-nowrap\">baigo SSO 单点登录系统</td>
