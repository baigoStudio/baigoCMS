...
return "<h3>SSO 设置</h3>
	...
	<h3>SSO 自动部署</h3>
	<p>请按照安装程序的提示操作。</p>
	<p><img src=\"{images}ssoAuto_1.jpg\" class=\"img-responsive\"></p>
	<p><img src=\"{images}ssoAuto_2.jpg\" class=\"img-responsive\"></p>
	<p>点击提交，提交成功后点击下一步。自动部署成功后，安装程序会直接跳转到创建管理员界面，详情请查看 <a href=\"{BG_URL_HELP}ctl.php?mod=install&act_get=admin#sso\">创建管理员</a>。</p>";
