...
return "<a name=\"list\"></a>
	...
	<div class=\"panel panel-default\">
		...
		<div class=\"panel-body\">
			...
			<p>栏目的英文别名，只能使用英文字母。此项一般用户 URL，当 <a href=\"{BG_URL_HELP}ctl.php?mod=admin&act_get=opt#visit\">访问方式</a> 设置为伪静态或纯静态，别名会显示在浏览的地址栏，如：http://www.domain.com/cate/<mark>service</mark>/3/，高亮部分既为别名</p>
