...
return "<h3>所有文章</h3>
    ...
    <div class=\"panel panel-default\">
        ...
        <div class=\"panel-body\">
            ...
            <p>文章、信息或产品的具体内容，点击“插入或上传”，可以上传图片、附件，或者把已上传的图片、附件插入到文章内容中。</p>

            <h4 class=\"text-info\">摘要类型</h4>
            <p>可选自动截取、仅截取文本、不要摘要和手工编辑四种，其中选择手机编辑将会弹出摘要编辑表单。</p>

            <h4 class=\"text-info\">摘要</h4>
            <p>文章的摘要信息，点击“插入或上传”，可以上传图片、附件，或者把已上传的图片、附件插入到文章摘要中。如空白，则自动选取文章的部分内容。</p>
            ...
            <p>可选择加入一个专题。可以按照关键词搜索专题，点“翻页”按钮，可以实现选框内的专题翻页。</p>
        </div>
    </div>
    ...
    <p>点“上传附件”标签，可以选择文件，自动上传，上出完毕以后会自动插入到文章。上传受上传设置和附件类型的限制，详见 <a href=\"{BG_URL_HELP}ctl.php?mod=admin&act_get=opt#upfile\">上传设置</a>、<a href=\"{BG_URL_HELP}ctl.php?mod=admin&act_get=attach#mime\">附件类型</a>。
    </p>
    <p>点“插入附件”标签，可以浏览已上传的文件，鼠标移到缩略图上，会弹出菜单，选择插入原图或缩略图。<a href=\"{BG_URL_HELP}ctl.php?mod=admin&act_get=attach#thumb\">缩略图</a> 详情。</p>
    <p>在编辑文章时，点“本文”标签，可以本文中用到的附件列出，可以方便的进行重新插入等操作。</p>
