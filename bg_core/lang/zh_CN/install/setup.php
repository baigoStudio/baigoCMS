...
return array(
    ...
    'text' => array(
        ...
        'sso'       => 'baigo CMS 的用户以及后台登录需要 baigo SSO 支持，baigo SSO 的部署方式，请查看 <a href="http://www.baigo.net/sso/" target="_blank">baigo SSO 官方网站</a>。如果您的网站没有部署 baigo SSO，请点击 <mark>SSO 自动部署</mark>。',
        'ssoAdmin'  => '本操作将同时为 baigo CMS 与 baigo SSO 创建管理员，拥有所有的管理权限。请牢记用户名与密码。',
    ),
);
