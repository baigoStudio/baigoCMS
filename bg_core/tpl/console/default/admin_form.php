            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label class="control-label"><?php echo $this->lang['mod']['label']['cateAllow']; ?></label>
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>
...
<?php include($cfg['pathInclude'] . 'console_foot.php'); ?>
    ...
    var opts_validator_form = {
        ...
        admin_mail: {
            ...
            msg: { selector: "#msg_admin_mail", too_short: "<?php echo $this->lang['rcode']['x010206']; ?>", too_long: "<?php echo $this->lang['rcode']['x010207']; ?>", format_err: "<?php echo $this->lang['rcode']['x010208']; ?>", ajaxIng: "<?php echo $this->lang['rcode']['x030401']; ?>", ajax_err: "<?php echo $this->lang['rcode']['x030402']; ?>" },
        ...
        admin_note: {
            ...
            msg: { selector: "#msg_admin_note", too_long: "<?php echo $this->lang['rcode']['x020212']; ?>" }
        },
        admin_type: {
            len: { min: 1, max: 0 },
            validate: { selector: "input[name='admin_type']", type: "radio", group: "#group_admin_type" },
            msg: { selector: "#msg_admin_type", too_few: "<?php echo $this->lang['rcode']['x020219']; ?>" }
        },
        admin_status: {
            len: { min: 1, max: 0 },
            validate: { selector: "input[name='admin_status']", type: "radio", group: "#group_admin_status" },
            msg: { selector: "#msg_admin_status", too_few: "<?php echo $this->lang['rcode']['x020213']; ?>" }
        }
    };
