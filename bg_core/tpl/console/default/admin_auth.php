...
include($cfg['pathInclude'] . 'console_head.php'); ?>
    ...
    <ul class="nav nav-pills mb-3">
        ...
        <li class="nav-item">
            <a href="<?php echo BG_URL_HELP; ?>index.php?m=console&a=admin#auth" class="nav-link" target="_blank">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <?php cate_list_allow($this->tplData['cateRows'], $this->tplData['cateAllow'], $this->lang['mod']); ?>
                                </tbody>
                            </table>
                        </div>
                            ...
                            <?php foreach ($this->profile as $_key=>$_value) { ?>
                                <div class="form-check">
                                    <label for="admin_allow_profile_<?php echo $_key; ?>" class="form-check-label">
                                        <input type="checkbox" name="admin_allow_profile[<?php echo $_key; ?>]" id="admin_allow_profile_<?php echo $_key; ?>" value="1" class="form-check-input">
...
<?php include($cfg['pathInclude'] . 'console_foot.php'); ?>
    ...
    var opts_validator_form = {
        admin_name: {
            ...
            ajax: { url: "<?php echo BG_URL_CONSOLE; ?>index.php?m=admin&c=request&a=chkauth", key: 'admin_name', type: "str" }
        },
        admin_nick: {
            len: { min: 0, max: 30 },
