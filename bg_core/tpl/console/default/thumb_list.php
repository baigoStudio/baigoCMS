                                        ...
                                        <li>
                                            <ul class="bg-nav-line">
                                                <?php if ($value['thumb_id'] > 0) { ?>
                                                    <li>
                                                        <a href="<?php echo BG_URL_CONSOLE; ?>index.php?mod=thumb&act=show&thumb_id=<?php echo $value['thumb_id']; ?>"><?php echo $this->lang['mod']['href']['show']; ?></a>
                                                    </li>
                                                    <li>
...
<?php include($cfg['pathInclude'] . 'console_foot.php'); ?>
    ...
    var opts_validator_list = {
        thumb_id: {
            ...
            msg: { selector: "#msg_thumb_id", too_few: "<?php echo $this->lang['rcode']['x030202']; ?>" }
        },
        act: {
            len: { min: 1, max: 0 },
    ...
    $(document).ready(function(){
        $("#thumb_modal").on("shown.bs.modal", function(event) {
            ...
            $("#thumb_modal .modal-content").load("<?php echo BG_URL_CONSOLE; ?>index.php?mod=thumb&act=form&thumb_id=" + _id + "&view=modal");
