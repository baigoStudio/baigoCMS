<?php $cfg = array(
    "title"          => $this->consoleMod["article"]["main"]["title"] . " &raquo; " . $this->consoleMod["article"]["sub"]["mark"]["title"],
    "menu_active"    => "article",
    "sub_active"     => "mark",
    "baigoCheckall"  => "true",
    "baigoValidator" => "true",
                ...
                <table class="table table-striped table-hover">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo $this->lang["label"]["markName"]; ?></th>
                        </tr>
                    </thead>
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul class="list-unstyled">
                                        ...
                                        <li>
                                            <a href="#mark_modal" data-toggle="modal" data-id="<?php echo $value["mark_id"]; ?>"><?php echo $this->lang["href"]["edit"]; ?></a>
                                        </li>
                                    </ul>
                                </td>
                            </tr>
...
<?php include($cfg["pathInclude"] . "console_foot.php"); ?>
    ...
    var opts_validator_list = {
        mark_ids: {
            ...
            msg: { selector: "#msg_mark_ids", too_few: "<?php echo $this->rcode["x030202"]; ?>" }
        }
    };
    ...
    $(document).ready(function(){
        $("#mark_modal").on("shown.bs.modal",function(event){
            ...
            $("#mark_modal .modal-content").load("<?php echo BG_URL_CONSOLE; ?>index.php?mod=mark&act=form&mark_id=" + _id + "&view=iframe");
        });
