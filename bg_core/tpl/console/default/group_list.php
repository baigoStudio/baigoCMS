<?php $cfg = array(
    "title"          => $this->consoleMod["group"]["main"]["title"],
    "menu_active"    => "group",
    "sub_active"     => "list",
    "baigoCheckall"  => "true",
    "baigoValidator" => "true",
                ...
                <table class="table table-striped table-hover">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo $this->lang["label"]["group"]; ?></th>
                            <th class="text-nowrap bg-td-md"><?php echo $this->lang["label"]["type"]; ?> / <?php echo $this->lang["label"]["groupNote"]; ?></th>
                        ...
                        <?php foreach ($this->tplData["groupRows"] as $key=>$value) { ?>
                            <tr>
                                    ...
                                    <ul class="list-unstyled">
                                        ...
                                        <li>
                                            <ul class="bg-nav-line">
                                                <li>
                                                    <a href="<?php echo BG_URL_CONSOLE; ?>index.php?mod=group&act=show&group_id=<?php echo $value["group_id"]; ?>"><?php echo $this->lang["href"]["show"]; ?></a>
                                                </li>
                                                <li>
                                                    <a href="<?php echo BG_URL_CONSOLE; ?>index.php?mod=group&act=form&group_id=<?php echo $value["group_id"]; ?>"><?php echo $this->lang["href"]["edit"]; ?></a>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
                                ...
                                <td class="text-nowrap bg-td-md">
                                    <ul class="list-unstyled">
                                        <li><?php echo $this->type["group"][$value["group_type"]]; ?></li>
                                        <li><?php echo $value["group_note"]; ?></li>
                                    </ul>
                                </td>
                                <td class="text-nowrap bg-td-sm">
                                    <?php group_status_process($value["group_status"], $this->status["group"]); ?>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
...
<?php include($cfg["pathInclude"] . "console_foot.php"); ?>
    ...
    var opts_validator_list = {
        group_id: {
            ...
            msg: { selector: "#msg_group_id", too_few: "<?php echo $this->rcode["x030202"]; ?>" }
        },
        act: {
            len: { min: 1, max: 0 },
