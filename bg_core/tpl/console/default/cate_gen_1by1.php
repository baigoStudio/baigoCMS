...
include($cfg['pathInclude'] . 'html_head.php'); ?>
    ...
    <table class="table">
        <thead>
            <tr>
                <th><?php echo $this->lang['common']['label']['cate']; ?> / <?php echo $this->lang['mod']['label']['id']; ?> / <?php echo $this->lang['mod']['label']['pageNo']; ?></th>
                    ...
                    <tr id="cate_<?php echo $_iii; ?>_tr" class="text-info">
                        <td>
                            ...
                            <div>
                                ...
                                /
                                <?php echo $this->lang['mod']['label']['pageCount'], $_iii, $this->lang['mod']['label']['pagePage']; ?>
                            </div>
                        </td>
