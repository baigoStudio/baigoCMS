...
<?php include($cfg['pathInclude'] . 'console_foot.php'); ?>
    ...
    var opts_validator_list = {
        custom_id: {
            ...
            msg: { selector: "#msg_custom_id", too_few: "<?php echo $this->lang['rcode']['x030202']; ?>" }
        },
        act: {
            len: { min: 1, max: 0 },
    ...
    $(document).ready(function(){
        $("#custom_modal").on("shown.bs.modal",function(event){
            ...
            $("#custom_modal .modal-content").load("<?php echo BG_URL_CONSOLE; ?>index.php?mod=custom&act=order&custom_id=" + _id + "&view=modal");
