...
include($cfg["pathInclude"] . "html_head.php");
    ...
    <?php } else { ?>
        <div class="alert alert-info">
            <h4><?php echo $this->lang["label"]["spec"]; ?></h4>
    ...
    if ($this->tplData["status"] == "loading") { ?>
        <meta http-equiv="refresh" content="0; url=<?php echo BG_URL_CONSOLE; ?>gen.php?mod=spec&act=list&page=<?php echo $this->tplData["pageRow"]["page"] + 1; ?>">
    <?php }
