                                ...
                                <ul class="list-unstyled">
                                    <li>
                                        <?php if (isset($value['groupRow']['group_name']) && !fn_isEmpty($value['groupRow']['group_name'])) { ?>
                                            <a href="<?php echo BG_URL_CONSOLE; ?>index.php?m=admin&a=list&group_id=<?php echo $value['admin_group_id']; ?>"><?php echo $value['groupRow']['group_name']; ?></a>
                                        <?php } else {
...
<?php include($cfg['pathInclude'] . 'console_foot.php'); ?>
    ...
    $(document).ready(function(){
        $("#admin_modal").on("shown.bs.modal",function(event){
            ...
            $("#admin_modal .modal-content").load("<?php echo BG_URL_CONSOLE; ?>index.php?m=admin&a=toGroup&admin_id=" + _id + "&view=modal");
