<?php if ($this->tplData["pmRow"]["pm_id"] < 1) {
    $title_sub    = $this->lang["page"]["send"];
} else {
    $title_sub    = $this->lang["page"]["reply"];
}

$cfg = array(
    "title"          => $this->lang["page"]["pm"] . " &raquo; " . $title_sub,
    "menu_active"    => "pm",
    "sub_active"     => "list",
    "baigoValidator" => "true",
    "baigoSubmit"    => "true",
            ...
            <div class="panel-body">
                <div class="form-group">
                    <div id="group_pm_to">
                        ...
                        <span class="help-block"><?php echo $this->lang["label"]["pmToNote"]; ?></span>
                    </div>
                </div>
...
<?php include($cfg["pathInclude"] . "console_foot.php"); ?>
    ...
    var opts_validator_form = {
        pm_to: {
            ...
            msg: { selector: "#msg_pm_to", too_short: "<?php echo $this->rcode["x110205"]; ?>" }
        },
        pm_title: {
            len: { min: 0, max: 90 },
