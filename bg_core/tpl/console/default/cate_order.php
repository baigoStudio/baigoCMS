    <div class="modal-header">
        ...
        <?php echo $this->lang['consoleMod']['cate']['main']['title'], ' &raquo; ', $this->lang['mod']['page']['order']; ?>
    </div>
    <div class="modal-body">
        <form name="cate_order" id="cate_order" class="form_input">
            ...
            <div class="form-group">
                <label class="control-label"><?php echo $this->lang['mod']['label']['cateName']; ?></label>
    ...
    var opts_validator_order = {
        order_type: {
            ...
            msg: { selector: "#msg_order_type", too_few: "<?php echo $this->lang['rcode']['x250219']; ?>" }
        }
    };
