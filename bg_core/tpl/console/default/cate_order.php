    <div class="modal-header">
        <div class="modal-title"><?php echo $this->lang['consoleMod']['cate']['main']['title'], ' &raquo; ', $this->lang['mod']['page']['order']; ?></div>
    ...
    <div class="modal-body">
        <form name="cate_order" id="cate_order" class="form_input">
            ...
            <div class="form-group">
                <label><?php echo $this->lang['mod']['label']['cateName']; ?></label>
    ...
    var opts_validator_order = {
        order_type: {
            ...
            msg: { too_few: "<?php echo $this->lang['rcode']['x250219']; ?>" }
        }
    };
    ...
    $(document).ready(function(){
        var obj_validate_order = $("#cate_order").baigoValidator(opts_validator_order, options_validator_order);
