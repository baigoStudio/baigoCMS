...
<head>
    ...
    <link href="<?php echo BG_URL_STATIC; ?>lib/bootstrap/4.1.1/css/bootstrap.min.css" type="text/css" rel="stylesheet">
    ...
    <?php if (isset($cfg['tagmanager'])) { ?>
        <link rel="stylesheet" href="<?php echo BG_URL_STATIC; ?>lib/typeahead/0.9.3/typeahead.css" type="text/css" rel="stylesheet">
        <link rel="stylesheet" href="<?php echo BG_URL_STATIC; ?>lib/tagmanager/3.0.1/tagmanager.css" type="text/css" rel="stylesheet">
    <?php }
