            ...
            <ul class="navbar-nav">
                <li class="nav-item dropdown<?php if (isset($cfg['menu_active']) && $cfg['menu_active'] == "pm") { ?> active<?php } ?>">
                    <a href="<?php echo BG_URL_CONSOLE; ?>index.php?m=pm&a=list" class="nav-link dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span id="box_pm_new" class="badge badge-secondary"></span>
                    </a>
                        ...
                        <div class="card border-primary">
                            <div class="list-group list-group-flush">
                                <?php foreach ($this->consoleMod as $key_m=>$value_m) { ?>
                                    <a class="list-group-item d-flex justify-content-between list-group-item-action<?php if (isset($cfg['menu_active']) && $cfg['menu_active'] == $key_m) { ?> active<?php } ?>" data-toggle="collapse" href="#bg-collapse-<?php echo $key_m; ?>" aria-expanded="true" aria-controls="bg-collapse-<?php echo $key_m; ?>">
                                        <span>
                                    ...
                                    <div id="bg-collapse-<?php echo $key_m; ?>" data-key="<?php echo $key_m; ?>" class="collapse<?php if (isset($cfg['menu_active']) && $cfg['menu_active'] == $key_m) { ?> show<?php } ?>" aria-labelledby="bg-heading-<?php echo $key_m; ?>" data-parent="#bg-accordion">
                                        ...
                                        foreach ($value_m['sub'] as $key_s=>$value_s) { ?>
                                            <a class="list-group-item<?php if (isset($cfg['menu_active']) && $cfg['menu_active'] == $key_m && isset($cfg['sub_active']) && $cfg['sub_active'] == $key_s) { ?> list-group-item-primary<?php } ?>" href="<?php echo BG_URL_CONSOLE; ?>index.php?m=<?php echo $value_s['mod']; ?>&a=<?php echo $value_s['act']; ?>">
                                ...
                                <div id="bg-collapse-opt" data-key="opt" class="collapse<?php if (isset($cfg['menu_active']) && $cfg['menu_active'] == 'opt') { ?> show<?php } ?>" aria-labelledby="bg-heading-opt" data-parent="#bg-accordion">
                                    ...
                                    <?php } ?>
                                    <a class="list-group-item <?php if (isset($cfg['menu_active']) && $cfg['menu_active'] == 'opt' && isset($cfg['sub_active']) && $cfg['sub_active'] == 'app') { ?> list-group-item-primary<?php } ?>" href="<?php echo BG_URL_CONSOLE; ?>index.php?m=app&a=list">
                    ...
                    <div class="float-right">
                        <?php if (defined('BG_MODULE_GEN') && BG_MODULE_GEN > 0 && defined('BG_VISIT_TYPE') && BG_VISIT_TYPE == 'static') { ?>
                            <div class="d-none d-md-block">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a data-url="<?php echo BG_URL_CONSOLE; ?>index.php?m=article_gen&a=list&overall=true&view=iframe" data-toggle="modal" href="#gen_modal" class="dropdown-item">
                                        <?php echo $this->lang['common']['btn']['genOverall']; ?>
                                    </a>
                                    <div class="dropdown-divider"></div>
                                    <div class="dropdown-header"><?php echo $this->lang['common']['label']['article']; ?></div>
                                    <a data-url="<?php echo BG_URL_CONSOLE; ?>index.php?m=article_gen&a=list&view=iframe" data-toggle="modal" href="#gen_modal" class="dropdown-item">
                                        <?php echo $this->lang['common']['btn']['gen1by1']; ?>
                                    </a>
                                    <a data-url="<?php echo BG_URL_CONSOLE; ?>index.php?m=article_gen&a=list&view=iframe&enforce=true" data-toggle="modal" href="#gen_modal" class="dropdown-item">
                                        <?php echo $this->lang['common']['btn']['genEnforce']; ?>
                                    </a>
                                    <div class="dropdown-divider"></div>
                                    <div class="dropdown-header"><?php echo $this->lang['common']['label']['cate']; ?></div>
                                    <a data-url="<?php echo BG_URL_CONSOLE; ?>index.php?m=cate_gen&a=1by1&view=iframe" data-toggle="modal" href="#gen_modal" class="dropdown-item">
                                        <?php echo $this->lang['common']['btn']['gen1by1']; ?>
                                    </a>
                                    <div class="dropdown-divider"></div>
                                    <div class="dropdown-header"><?php echo $this->lang['common']['label']['spec']; ?></div>
                                    <a data-url="<?php echo BG_URL_CONSOLE; ?>index.php?m=spec_gen&a=1by1&overall=true&view=iframe" data-toggle="modal" href="#gen_modal" class="dropdown-item">
                                        <?php echo $this->lang['common']['btn']['genOverall']; ?>
                                    </a>
                                    <a data-url="<?php echo BG_URL_CONSOLE; ?>index.php?m=spec_gen&a=list&view=iframe" data-toggle="modal" href="#gen_modal" class="dropdown-item">
                                        <?php echo $this->lang['common']['btn']['genList']; ?>
                                    </a>
                                    <a data-url="<?php echo BG_URL_CONSOLE; ?>index.php?m=spec_gen&a=1by1&view=iframe" data-toggle="modal" href="#gen_modal" class="dropdown-item">
                                        <?php echo $this->lang['common']['btn']['gen1by1']; ?>
                                    </a>
                                    <div class="dropdown-divider"></div>
                                    <div class="dropdown-header"><?php echo $this->lang['common']['label']['call']; ?></div>
                                    <a data-url="<?php echo BG_URL_CONSOLE; ?>index.php?m=call_gen&a=list&view=iframe" data-toggle="modal" href="#gen_modal" class="dropdown-item">
                                        <?php echo $this->lang['common']['btn']['gen1by1']; ?>
                                    </a>
                                </div>
                            </div>
