<?php $cfg = array(
    "title"          => $this->lang["page"]["profile"] . " &raquo; " . $this->type["profile"]["mailbox"]["title"],
    "menu_active"    => "profile",
    "sub_active"     => "mailbox",
    "baigoValidator" => "true",
    "baigoSubmit"    => "true",
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label class="control-label"><?php echo $this->lang["label"]["mailOld"]; ?></label>
                            <input type="text" class="form-control" readonly value="<?php echo $this->tplData["ssoRow"]["user_mail"]; ?>">
                        </div>

                        <div class="form-group">
                            <div id="group_admin_mail_new">
                                <label class="control-label"><?php echo $this->lang["label"]["mailNew"]; ?><span id="msg_admin_mail_new">*</span></label>
...
<?php include($cfg["pathInclude"] . "console_foot.php"); ?>
    ...
    var opts_validator_form = {
        ...
        admin_mail_new: {
            ...
            msg: { selector: "#msg_admin_mail_new", too_short: "<?php echo $this->rcode["x010206"]; ?>", too_long: "<?php echo $this->rcode["x010207"]; ?>", format_err: "<?php echo $this->rcode["x010208"]; ?>", ajaxIng: "<?php echo $this->rcode["x030401"]; ?>", ajax_err: "<?php echo $this->rcode["x030402"]; ?>" },
