        ...
        <div class="pull-left">
            <div class="form-group">
                <ul class="nav nav-pills bg-nav-pills">
                    <li class="active">
                        <a href="#pane_insert" id="btn_insert" data-toggle="tab"><?php echo $this->lang['mod']['href']['insert']; ?></a>
                    </li>
                    <li>
                    ...
                    <?php if ($this->tplData['articleRow']['article_id'] > 0) { ?>
                        <li>
                            <a href="#pane_article" id="btn_article" data-toggle="tab"><?php echo $this->lang['mod']['href']['uploadArticle']; ?></a>
                        </li>
                    <?php } ?>
                </ul>
            </div>
    ...
    function get_page(result, _page, _year, _month, _ext, _key, func) {
        var _str_page = "<ul class=\"pagination pagination-sm bg-pagination\">";
                ...
                "<div class=\"caption\">" +
                    ...
                    "<div class=\"dropdown\">" +
                        "<button type=\"button\" class=\"btn btn-success btn-block btn-sm dropdown-toggle\" data-toggle=\"dropdown\">"+
                            "<?php echo $this->lang['mod']['href']['insert']; ?>" +
                            "&nbsp;<span class=\"caret\"></span>" +
                        "</button>" +
                        "<ul class=\"dropdown-menu\">" +
                            "<li><a href=\"javascript:insertAttach('" + _value.attach_url + "', '" + _value.attach_name + "', '" + _value.attach_id + "', '" + _value.attach_type + "', '" + _value.attach_ext + "');\"><?php echo $this->lang['mod']['href']['insertOriginal']; ?></a></li>";

                            if (_value.attach_type == "image") {
                                $.each(_value.attach_thumb, function(thumb_i, field_thumb){
                                    _str_appent += "<li><a href=\"javascript:insertAttach('" + field_thumb.thumb_url+ "', '" + _value.attach_name + "', '" + _value.attach_id + "', '" + _value.attach_type + "', '" + _value.attach_ext + "');\"><?php echo $this->lang['mod']['href']['insert']; ?>: " + field_thumb.thumb_width + "x" + field_thumb.thumb_height + " " + _thumb_type[field_thumb.thumb_type] + "</a></li>";
                                });
                            }

                            _str_appent += "<li><a href=\"" + _value.attach_url + "\" target=\"_blank\"><?php echo $this->lang['mod']['href']['browseOriginal']; ?></a></li>" +
                        "</ul>" +
                    "</div>" +
                "</div>" +
            "</div>" +
