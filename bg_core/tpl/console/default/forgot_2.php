        ...
        <div class="tab-pane active" id="mail">
            <form name="forgot_mail" id="forgot_mail">
                ...
                <?php } else { ?>
                    ...
                    <div class="form-group">
                        <div id="group_captcha_mail">
                            <label class="control-label"><?php echo $this->lang['mod']['label']['captcha']; ?><span id="msg_captcha_mail">*</span></label>
                            ...
                            <input type="text" name="captcha" id="captcha_mail" placeholder="<?php echo $this->lang['rcode']['x030201']; ?>" data-validate class="form-control input-lg">
                        </div>
                    </div>
        ...
        <div class="tab-pane" id="qa">
            <form name="forgot_qa" id="forgot_qa">
                ...
                <?php } else {
                    ...
                    <div class="form-group">
                        <div id="group_captcha_qa">
                            <label class="control-label"><?php echo $this->lang['mod']['label']['captcha']; ?><span id="msg_captcha_qa">*</span></label>
                            <ul class="list-inline">
                                <li>
                                    <a href="javascript:void(0);" class="captchaBtn">
                                        <img src="<?php echo BG_URL_CONSOLE; ?>index.php?mod=captcha&act=make" class="captchaImg" alt="<?php echo $this->lang['mod']['btn']['captcha']; ?>">
                            ...
                            <input type="text" name="captcha" id="captcha_qa" placeholder="<?php echo $this->lang['rcode']['x030201']; ?>" data-validate class="form-control input-lg">
                        </div>
                    </div>
...
<?php include($cfg['pathInclude'] . 'login_foot.php'); ?>
    ...
    var opts_validator_mail = {
        captcha_mail: {
            len: { min: 4, max: 4 },
            validate: { type: "ajax", format: "text", group: "#group_captcha_mail" },
            msg: { selector: "#msg_captcha_mail", too_short: "<?php echo $this->lang['rcode']['x030201']; ?>", too_long: "<?php echo $this->lang['rcode']['x030201']; ?>", ajaxIng: "<?php echo $this->lang['rcode']['x030401']; ?>", ajax_err: "<?php echo $this->lang['rcode']['x030402']; ?>" },
    ...
    var opts_validator_qa = {
        ...
        captcha_qa: {
            len: { min: 4, max: 4 },
            validate: { type: "ajax", format: "text", group: "#group_captcha_qa" },
            msg: { selector: "#msg_captcha_qa", too_short: "<?php echo $this->lang['rcode']['x030201']; ?>", too_long: "<?php echo $this->lang['rcode']['x030201']; ?>", ajaxIng: "<?php echo $this->lang['rcode']['x030401']; ?>", ajax_err: "<?php echo $this->lang['rcode']['x030402']; ?>" },
            ajax: { url: "<?php echo BG_URL_CONSOLE; ?>request.php?mod=captcha&act=chk", key: "captcha", type: "str" }
        }
    };
