        ...
        <div class="tab-pane" id="qa">
            <form name="forgot_qa" id="forgot_qa">
                ...
                <?php } else {
                    ...
                    <div class="form-group">
                        <button type="button" class="btn btn-primary bg-submit-qa"><?php echo $this->lang["btn"]["submit"]; ?></button>
                    </div>
                <?php } ?>
            </form>
        </div>
...
<?php include($cfg["pathInclude"] . "login_foot.php"); ?>
    ...
    $(document).ready(function(){
        var obj_validator_form  = $("#forgot_qa").baigoValidator(opts_validator_form);
