    <div class="modal-header">
        <div class="modal-title"><?php echo $this->lang['consoleMod']['article']['sub']['custom'], ' &raquo; ', $this->lang['mod']['page']['order']; ?></div>
    ...
    <div class="modal-body">
        <form name="custom_order" id="custom_order" class="form_input">
            ...
            <div class="form-group">
                <label><?php echo $this->lang['mod']['label']['custom']; ?></label>
                <div class="form-text"><?php echo $this->tplData['customRow']['custom_name']; ?></div>
            </div>
    ...
    var opts_validator_order = {
        order_type: {
            ...
            msg: { too_few: "<?php echo $this->lang['rcode']['x200210']; ?>" }
        }
    };
    ...
    $(document).ready(function(){
        var obj_validate_order = $("#custom_order").baigoValidator(opts_validator_order, options_validator_order);
