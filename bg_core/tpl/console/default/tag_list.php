...
<?php include($cfg['pathInclude'] . 'console_foot.php'); ?>
    ...
    var opts_validator_list = {
        tag_id: {
            ...
            msg: { selector: "#msg_tag_id", too_few: "<?php echo $this->lang['rcode']['x030202']; ?>" }
        },
        act: {
            len: { min: 1, max: 0 },
    ...
    $(document).ready(function(){
        $("#tag_modal").on("shown.bs.modal", function(event) {
            ...
            $("#tag_modal .modal-content").load("<?php echo BG_URL_CONSOLE; ?>index.php?mod=tag&act=form&tag_id=" + _id + "&view=modal");
