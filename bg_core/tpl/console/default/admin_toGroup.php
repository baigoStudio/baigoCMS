    <form name="admin_form" id="admin_form">
        ...
        <div class="modal-header">
            ...
            <?php echo $this->consoleMod["admin"]["main"]["title"]; ?> - <?php echo $this->lang["href"]["toGroup"]; ?>
        </div>
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <div id="group_group_id">
                    <label class="control-label"><?php echo $this->lang["label"]["adminGroup"]; ?><span id="msg_group_id">*</span></label>
                    <select name="group_id" id="group_id" data-validate class="form-control">
                        ...
                        <option <?php if ($this->tplData["adminRow"]["admin_group_id"] == 0) { ?>selected<?php } ?> value="0"><?php echo $this->lang["option"]["noGroup"]; ?></option>
    ...
    var opts_validator_form = {
        group_id: {
            ...
            msg: { selector: "#msg_group_id", too_few: "<?php echo $this->rcode["x020214"]; ?>" }
        }
    };
