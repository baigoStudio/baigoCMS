...
include($cfg['pathInclude'] . 'console_head.php'); ?>
    ...
    <form name="gsite_form" id="gsite_form">
        ...
        <input type="hidden" name="act" value="stepList">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="form-group">
                            <div id="group_gsite_list_selector">
                                <label class="control-label"><?php echo $this->lang['mod']['label']['selectorList']; ?><span id="msg_gsite_list_selector">*</span></label>
                                <input type="text" name="gsite_list_selector" id="gsite_list_selector" value="<?php echo $this->tplData['gsiteRow']['gsite_list_selector']; ?>" data-validate class="form-control">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading"><?php echo $this->lang['mod']['label']['previewList']; ?></div>
...
include($cfg['pathInclude'] . 'console_foot.php'); ?>
    ...
    var opts_validator_form = {
        gsite_list_selector: {
            len: { min: 1, max: 100 },
            validate: { type: "str", format: "text", group: "#group_gsite_list_selector" },
            msg: { selector: "#msg_gsite_list_selector", too_short: "<?php echo $this->lang['rcode']['x270214']; ?>", too_long: "<?php echo $this->lang['rcode']['x270215']; ?>" }
        }
    };
    ...
    $(document).ready(function(){
        ...
        $("#gsite_preview").html("<div class='embed-responsive embed-responsive-16by9'><iframe class='embed-responsive-item' scrolling='auto' src='<?php echo BG_URL_CONSOLE; ?>index.php?mod=gsite_preview&act=list&gsite_id=<?php echo $this->tplData['gsiteRow']['gsite_id']; ?>'></iframe></div>");

        $("#gsite_source").html("<div class='embed-responsive embed-responsive-16by9'><iframe class='embed-responsive-item' scrolling='auto' src='<?php echo BG_URL_CONSOLE; ?>index.php?mod=gsite_source&act=list&gsite_id=<?php echo $this->tplData['gsiteRow']['gsite_id']; ?>'></iframe></div>");
    });
    </script>
