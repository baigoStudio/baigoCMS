...
include($cfg['pathInclude'] . 'gsite_head.php'); ?>
    ...
    <form name="gsite_form" id="gsite_form">
        ...
        <input type="hidden" name="a" value="stepList">
        ...
        <div class="row">
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label><?php echo $this->lang['mod']['label']['selectorList']; ?> <span class="text-danger">*</span></label>
                            ...
                            <small class="form-text" id="msg_gsite_list_selector"></small>
                ...
                <div class="card mt-3">
                    <div class="card-header"><?php echo $this->lang['mod']['label']['previewList']; ?></div>
...
include($cfg['pathInclude'] . 'console_foot.php'); ?>
    ...
    var opts_validator_form = {
        gsite_list_selector: {
            ...
            msg: { too_short: "<?php echo $this->lang['rcode']['x270214']; ?>", too_long: "<?php echo $this->lang['rcode']['x270215']; ?>" }
        }
    };
    ...
    $(document).ready(function(){
        ...
        $("#gsite_preview").html("<div class='embed-responsive embed-responsive-16by9'><iframe class='embed-responsive-item' scrolling='auto' src='<?php echo BG_URL_CONSOLE; ?>index.php?m=gsite_preview&a=list&gsite_id=<?php echo $this->tplData['gsiteRow']['gsite_id']; ?>'></iframe></div>");

        $("#gsite_source").html("<div class='embed-responsive embed-responsive-16by9'><iframe class='embed-responsive-item' scrolling='auto' src='<?php echo BG_URL_CONSOLE; ?>index.php?m=gsite_source&a=list&gsite_id=<?php echo $this->tplData['gsiteRow']['gsite_id']; ?>'></iframe></div>");
    });
    </script>
