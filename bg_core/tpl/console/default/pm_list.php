                ...
                <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <th>
                                <?php if ($this->tplData["search"]["type"] == "in") {
                                    echo $this->lang["label"]["pmFrom"];
                                } else {
                                    echo $this->lang["label"]["pmTo"];
                                } ?>
                            </th>
                    ...
                    <tbody>
                        <?php foreach ($this->tplData["pmRows"] as $key=>$value) {
                            $_arr_status = pm_status_process($value, $this->status["pm"], $this->lang, $this->tplData["search"]["type"]); ?>
                                ...
                                <div class="form-group">
                                    <div id="group_act">
                                        <select name="act" id="act" data-validate class="form-control input-sm">
                                            ...
                                            <?php if ($this->tplData["search"]["type"] == "in") {
                                                foreach ($this->status["pm"] as $key=>$value) { ?>
