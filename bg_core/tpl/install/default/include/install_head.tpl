    ...
    <div class="container global">
        ...
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        <a href="javascript:void(0);" class="dropdown-toggle {if isset($tplData.errCount) && $tplData.errCount > 0}disabled{/if}" data-toggle="dropdown">
                            {$lang.btn.jump}
        ...
        <div class="panel panel-info">
            <div class="panel-heading">
                <h4>{$lang.page.install} <span class="label label-info">{$cfg.sub_title}</span></h4>
            </div>
