<?php include($cfg["pathInclude"] . "html_head.php"); ?>
    ...
    <div class="container">
        <div class="bg-panel">
            <h3><?php echo $this->lang["page"]["upgrade"]; ?></h3>
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    ...
                    <div class="alert alert-warning">
                        ...
                        <?php echo $this->lang["label"]["upgrade"]; ?>
                        <span class="label label-warning"><?php echo BG_INSTALL_VER; ?></span>
                        <?php echo $this->lang["label"]["to"]; ?>
                        <span class="label label-warning"><?php echo PRD_CMS_VER; ?></span>
                    </div>
