                    <div class="btn-group dropup">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <?php foreach ($this->opt as $key_opt=>$value_opt) { ?>
                                <li<?php if ($GLOBALS["act"] == $key_opt) { ?> class="active"<?php } ?>><a href="<?php echo BG_URL_INSTALL; ?>index.php?mod=upgrade&act=<?php echo $key_opt; ?>"><?php echo $value_opt["title"]; ?></a></li>
                            <?php } ?>
