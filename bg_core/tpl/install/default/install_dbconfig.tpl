	...
	<form name="upgrade_form_dbconfig" id="upgrade_form_dbconfig">
		...
		<div class="form-group">
			<div id="group_db_table">
				...
				<input type="text" name="db_table" id="db_table" class="validate form-control input-lg" value="{if $smarty.const.BG_DB_TABLE}{$smarty.const.BG_DB_TABLE}{else}cms_{/if}">
			</div>
		</div>
