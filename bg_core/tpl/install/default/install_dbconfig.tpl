	...
	<form name="install_dbconfig" id="install_dbconfig">
		...
		<div class="form-group">
			<div id="group_db_charset">
				...
				<input type="text" value="{$smarty.const.BG_DB_CHARSET}" name="db_charset" id="db_charset" class="validate form-control input-lg">
			</div>
		</div>
		...
		<div class="form-group">
			<div id="group_db_table">
				...
				<input type="text" value="{$smarty.const.BG_DB_TABLE}" name="db_table" id="db_table" class="validate form-control input-lg">
			</div>
		</div>
