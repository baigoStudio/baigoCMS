...
{include "include/install_head.tpl" cfg=$cfg}
	...
	<div class="page_body">
		<form name="instal_form_admin" id="instal_form_admin" autocomplete="off">
...
{include "include/install_foot.tpl" cfg=$cfg}
	...
	var opts_submit_form = { ajax_url: "{$smarty.const.BG_URL_INSTALL}ajax.php?mod=install", btn_text: "{$lang.btn.login}", btn_url: "{$smarty.const.BG_URL_ADMIN}admin.php" };
