...
{include "include/install_head.tpl" cfg=$cfg}
	...
	<div class="page_body">
		<form name="instal_form_sso" id="instal_form_sso">
			...
			<ul>
				<li class="note">{$lang.text.installSso}</li>
				<li class="link"><a href="{$smarty.const.BG_URL_INSTALL}install.php?mod=install&act_get=ssoauto">{$lang.href.ssoauto}</a></li>
