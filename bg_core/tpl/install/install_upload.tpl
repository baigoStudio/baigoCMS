...
{include "include/install_head.tpl" cfg=$cfg}
	...
	<form name="instal_form_upload" id="instal_form_upload">
...
{include "include/install_foot.tpl" cfg=$cfg}
	...
	var opts_validator_form = {
		{foreach $opt["upload"] as $key=>$value}
	...
	$(document).ready(function(){
		var obj_validator_form = $("#instal_form_upload").baigoValidator(opts_validator_form);
		var obj_submit_form = $("#instal_form_upload").baigoSubmit(opts_submit_form);
