	...
	<div class="page_body">
		<form name="instal_form_dbconfig" id="instal_form_dbconfig">
			...
			<ul>
				...
				<li class="field"><input type="text" name="db_name" id="db_name" class="validate" value="{if $smarty.const.BG_DB_NAME}{$smarty.const.BG_DB_NAME}{else}baigo_cms{/if}" /></li>
				<li class="title">{$lang.label.dbUser}<span id="msg_db_user">*</span></li>
				<li class="field"><input type="text" name="db_user" id="db_user" class="validate" value="{if $smarty.const.BG_DB_USER}{$smarty.const.BG_DB_USER}{else}baigo_cms{/if}" /></li>
				...
				<li class="field"><input type="text" name="db_table" id="db_table" class="validate" value="{if $smarty.const.BG_DB_TABLE}{$smarty.const.BG_DB_TABLE}{else}bg_{/if}" /></li>
...
{include "include/install_foot.tpl" cfg=$cfg}
	...
	var opts_submit_form = { ajax_url: "{$smarty.const.BG_URL_INSTALL}ajax.php?mod=install", btn_text: "{$lang.btn.installNext}", btn_url: "{$smarty.const.BG_URL_INSTALL}install.php?mod=install&act_get=dbtable" };
