...
{include "include/admin_head.tpl" cfg=$cfg}
	...
	<form name="admin_form" id="admin_form" class="tform">
		...
		<div>
			...
			<ul>
				...
				<li class="field">
					<input type="text" name="admin_name" id="admin_name" {if $tplData.adminRow.admin_id > 0}readonly="readonly" class="short"{else}class="validate short"{/if} value="{$tplData.adminRow.admin_name}" />
				</li>
