				...
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<select name="custom_type" id="custom_type" class="validate form-control">
								<option value="">{$lang.option.pleaseSelect}</option>
			...
			<div class="col-md-3">
				<div class="well">
					...
					<div class="form-group">
						...
						<select name="custom_cate_id" id="custom_cate_id" class="validate form-control">
							<option value="">{$lang.option.pleaseSelect}</option>
					...
					<div class="form-group">
						<label for="custom_format" class="control-label">{$lang.label.format}<span id="msg_custom_format">*</span></label>
						<select name="custom_format" id="custom_format" class="validate form-control">
							<option value="">{$lang.option.pleaseSelect}</option>
...
{include "{$smarty.const.BG_PATH_TPLSYS}admin/default/include/admin_foot.tpl"}
	...
	var opts_validator_form = {
		...
		custom_format: {
			length: { min: 1, max: 0 },
			validate: { type: "select" },
			msg: { id: "msg_custom_format", too_few: "{$alert.x200205}" }
		},
		custom_parent_id: {
			length: { min: 1, max: 0 },
			validate: { type: "select" },
		...
		custom_cate_id: {
			length: { min: 1, max: 0 },
			validate: { type: "select" },
			msg: { id: "msg_custom_cate_id", too_few: "{$alert.x200213}" }
		},
		custom_status: {
			length: { min: 1, max: 0 },
			validate: { type: "radio" },
