					...
					<div class="panel-body">
						...
						<div class="form-group">
							<div id="group_admin_pass">
								<label form="admin_pass" class="control-label">{$lang.label.passOld}<span id="msg_admin_pass">*</span></label>
						...
						<div class="form-group">
							<div id="group_admin_pass_new">
								<label form="admin_pass_new" class="control-label">{$lang.label.passNew}<span id="msg_admin_pass_new">*</span></label>
						...
						<div class="form-group">
							<div id="group_admin_pass_confirm">
								<label form="admin_pass_confirm" class="control-label">{$lang.label.passConfirm}<span id="msg_admin_pass_confirm">*</span></label>
