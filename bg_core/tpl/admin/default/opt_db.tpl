			...
			<div class="panel-body">
				...
				<div class="form-group">
					<div id="group_db_name">
						...
						<input type="text" name="db_name" id="db_name" class="validate form-control" value="{if $smarty.const.BG_DB_NAME}{$smarty.const.BG_DB_NAME}{else}baigo_cms{/if}">
					</div>
				</div>
				...
				<div class="form-group">
					<div id="group_db_user">
						...
						<input type="text" name="db_user" id="db_user" class="validate form-control" value="{if $smarty.const.BG_DB_USER}{$smarty.const.BG_DB_USER}{else}baigo_cms{/if}">
					</div>
				</div>
				...
				<div class="form-group">
					<div id="group_db_table">
						...
						<input type="text" name="db_table" id="db_table" class="validate form-control" value="{if $smarty.const.BG_DB_TABLE}{$smarty.const.BG_DB_TABLE}{else}cms_{/if}">
					</div>
				</div>
