...
{include "include/admin_head.tpl" cfg=$cfg}
	...
	<div class="pull-left list_left">
		<div class="panel panel-default">
			<div class="panel-heading">
				<form name="belong_search" id="belong_search" class="form-inline" action="{$smarty.const.SM_URL_USER}ctl.php" method="get">
	...
	<div class="pull-right list_right">
		<div class="panel panel-default">
			<div class="panel-heading">
				<form name="select_search" id="select_search" class="form-inline" action="{$smarty.const.SM_URL_USER}ctl.php" method="get">
