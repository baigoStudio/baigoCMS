		...
		<div class="pull-left">
			<div class="form-group">
				<ul class="nav nav-pills nav_baigo">
					<li>
						<a href="{$smarty.const.BG_URL_ADMIN}ctl.php?mod=tag&act_get=form">
					...
					<table class="table table-striped table-hover">
						...
						<tbody>
							{foreach $tplData.tagRows as $key=>$value}
								...
								{/if}
								<tr>
									<td class="text-nowrap td_mn"><input type="checkbox" name="tag_id[]" value="{$value.tag_id}" id="tag_id_{$value.tag_id}" group="tag_id" class="chk_all validate"></td>
									...
									<td>
										<ul class="list-unstyled">
											...
											<li>
												<a href="{$smarty.const.BG_URL_ADMIN}ctl.php?mod=tag&act_get=form&tag_id={$value.tag_id}">{$lang.href.edit}</a>
											</li>
										</ul>
									</td>
