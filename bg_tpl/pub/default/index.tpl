    ...
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img src="{$smarty.const.BG_URL_STATIC}pub/{$smarty.const.BG_SITE_TPL}/image/index_slide_1.jpg">
            </div>
            <div class="item">
                <img src="{$smarty.const.BG_URL_STATIC}pub/{$smarty.const.BG_SITE_TPL}/image/index_slide_2.jpg">
            </div>
        </div>
