...
{if $cfg.colorbox}
	<!--colorbox 样式-->
	<link href="http://res.iwee.cn/static/js/colorbox/colorbox.css" type="text/css" rel="stylesheet" />
	<script src="http://res.iwee.cn/static/js/colorbox/jquery.colorbox-min.js" type="text/javascript"></script>
{/if}
