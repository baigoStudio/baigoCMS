...
class Admin extends Admin_Base {
    ...
    function submit() {
        ...
        if (isset($this->inputSubmit['admin_allow_cate'])) {
            $_arr_adminData['admin_allow_cate'] = $this->inputSubmit['admin_allow_cate'];
        }
        ...
        $_arr_adminData['admin_allow_cate']       = Arrays::toJson($_arr_adminData['admin_allow_cate']);
