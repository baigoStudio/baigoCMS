...
<body>
  ...
  <div class="container p-5">
    <div class="mb-5">
      <img src="{:DIR_STATIC}image/logo_ginkgo.svg" class="bg-icon img-fluid" title="ginkgo" alt="ginkgo">
    </div>

    <p class="lead">
      ginkgo 是一个免费开源的轻量级 PHP 开发框架。其演化自 baigo 的几款开源 PHP 系统。以简单简单、易用为设计、开发的宗旨，符合网络标准。安装部署简单、使用简单。
    </p>
  </div>
