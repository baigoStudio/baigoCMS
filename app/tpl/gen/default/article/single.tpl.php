  ...
  $(document).ready(function(){
    $.ajax({
      ...
      error: function (result) {
        ...
        $('#article_<?php echo $articleRow['article_id']; ?> .bg-icon').html('<?php include($tpl_icon . 'times-circle' . BG_EXT_SVG); ?>');
      ...
      success: function(_result){ //读取返回结果
        ...
        $('#article_<?php echo $articleRow['article_id']; ?> .bg-icon').html(_icon);
