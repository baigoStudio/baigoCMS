                            ...
                            <td>
                                ...
                                <div class="bg-manage-menu">
                                    <div class="d-flex flex-wrap">
                                        ...
                                        <a href="#admin_modal" data-toggle="modal" data-id="<?php echo $value['admin_id']; ?>" class="mr-2">
...
<?php include($cfg['pathInclude'] . 'console_foot' . GK_EXT_TPL); ?>
    ...
    $(document).ready(function(){
        $('#admin_modal').on('shown.bs.modal',function(event){
            ...
            $('#admin_modal .modal-content').load('<?php echo $route_console; ?>admin/addon/id/' + _id + '/view/modal/');
