                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <table class="bg-table">
                            <tbody>
                                <?php $_is_edit = false;
                                include($cfg['pathInclude'] . 'cate_list_allow' . GK_EXT_TPL); ?>
                            </tbody>
                        </table>
                    </div>
        ...
        <div class="col-xl-3">
            <div class="card bg-light">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label><?php echo $lang->get('Member of group'); ?></label>
                        <div>
                            <?php if (isset($groupRow['group_name'])) { ?>
                                <a href="<?php echo $route_console; ?>group/show/id/<?php echo $groupRow['group_id']; ?>/">
