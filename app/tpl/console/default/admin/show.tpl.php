        ...
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <table class="bg-table">
              <tbody>
                <?php $_is_edit = false;
                include($tpl_include . 'cate_list_allow' . GK_EXT_TPL); ?>
              </tbody>
            </table>
          </div>
    ...
    <div class="col-xl-3">
      <div class="card bg-light">
        <div class="card-body">
          ...
          <div class="form-group">
            <label class="text-muted font-weight-light"><?php echo $lang->get('Member of group'); ?></label>
            <div class="form-text font-weight-bolder">
              <?php if (isset($groupRow['group_name'])) { ?>
                <a href="<?php echo $hrefRow['group-show'], $groupRow['group_id']; ?>">
