        ...
        var _str_page = '<ul class="pagination pagination-sm mt-1 mb-2">';
            ...
            _str_page += '">';
                if (isNaN(result.pageRow.prev)) {
                    ...
                    _str_page += '<a href="javascript:void(0);" data-page="' + (result.pageRow.page - 1) + '" data-key="' + key + '" title="<?php echo $_lang_pagePrev; ?>" class="page-link"><span class="fas fa-chevron-left"></span></a>';
                }
            _str_page += '</li>';
            ...
            _str_page += '">';
                if (isNaN(result.pageRow.next)) {
                    ...
                    _str_page += '<a href="javascript:void(0);" data-page="' + (result.pageRow.page + 1) + '" data-key="' + key + '" title="<?php echo $_lang_pageNext; ?>" class="page-link"><span class="fas fa-chevron-right"></span></a>';
                }
            _str_page += '</li>';
    ...
    function reloadAlbum(page, key) {
        ...
        var _url                = '<?php echo $route_console; ?>album/lists/';
