...
include($tpl_include . 'console_head' . GK_EXT_TPL); ?>
  ...
  <div class="d-flex justify-content-between">
    ...
    <form name="call_search" id="call_search" class="d-none d-lg-block" action="<?php echo $hrefRow['index']; ?>">
  ...
  <div class="card bg-light mb-3">
    <div class="card-body">
      <form name="call_cache" id="call_cache" action="<?php echo $hrefRow['cache']; ?>">
  ...
  <form name="call_list" id="call_list" action="<?php echo $hrefRow['delete']; ?>">
    <input type="hidden" name="<?php echo $token['name']; ?>" value="<?php echo $token['value']; ?>">
            ...
            <tr class="bg-manage-tr">
              ...
              <td>
                ...
                <div class="mb-2 text-wrap text-break">
                  <a href="<?php echo $hrefRow['edit'], $value['call_id']; ?>">
                    <?php echo $value['call_name']; ?>
                  </a>
                </div>
                <div class="bg-manage-menu">
                  <div class="d-flex flex-wrap">
                    <a href="<?php echo $hrefRow['show'], $value['call_id']; ?>" class="mr-2">
                      <span class="bg-icon"><?php include($tpl_icon . 'eye' . BG_EXT_SVG); ?></span>
                      <?php echo $lang->get('Show'); ?>
                    </a>
                    <a href="<?php echo $hrefRow['edit'], $value['call_id']; ?>" class="mr-2">
                      <span class="bg-icon"><?php include($tpl_icon . 'edit' . BG_EXT_SVG); ?></span>
                      <?php echo $lang->get('Edit'); ?>
                    </a>
                    <?php if ($gen_open === true) { ?>
                      <a href="#gen_modal" data-url="<?php echo $hrefRow['gen'], $value['call_id']; ?>" data-toggle="modal" class="mr-2">
...
<?php include($tpl_include . 'console_foot' . GK_EXT_TPL); ?>
  ...
  $(document).ready(function(){
    ...
    var obj_submit_list     = $('#call_list').baigoSubmit(opts_submit);
    ...
    var obj_cache = $('#call_cache').baigoSubmit(opts_submit);
