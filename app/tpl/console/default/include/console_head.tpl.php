                    ...
                    <div id="bg-accordion" class="bg-accordion">
                        <div class="card border-primary">
                            <div class="list-group list-group-flush">
                                ...
                                <a class="list-group-item d-flex justify-content-between align-items-center list-group-item-action<?php if (isset($cfg['menu_active']) && $cfg['menu_active'] == 'opt') { ?> bg-primary border-primary active<?php } ?>" data-toggle="collapse" href="#bg-collapse-opt">
                                    <span>
                                ...
                                <div id="bg-collapse-opt" data-key="opt" class="collapse bg-collapse<?php if (isset($cfg['menu_active']) && $cfg['menu_active'] == 'opt') { ?> show<?php } ?>" data-parent="#bg-accordion">
                                    ...
                                    foreach ($config['console']['opt'] as $key_s=>$value_s) { ?>
                                        <a class="list-group-item<?php if (isset($cfg['menu_active']) && $cfg['menu_active'] == 'opt' && isset($cfg['sub_active']) && $cfg['sub_active'] == $key_s) { ?> list-group-item-primary<?php } ?>" href="<?php echo $route_console; ?>opt/<?php echo $key_s; ?>/">
                                            <?php echo $lang->get($value_s['title'], 'console.common'); ?>
                                        </a>
                                    <?php } ?>
                                </div>
                            ...
                            <div class="card-footer d-none d-lg-block">
                                <small>
                                    <a href="<?php echo PRD_CMS_HELP; ?>" target="_blank">
                ...
                <div class="clearfix">
                    ...
                    <div class="float-right d-none d-md-inline">
                        <?php if ($gen_open === true) { ?>
                            <div class="btn-group">
                                <a class="btn btn-success" data-url="<?php echo $route_gen; ?>article/index/overall/overall/view/iframe/" data-toggle="modal" href="#gen_modal">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a data-url="<?php echo $route_gen; ?>article/index/overall/overall/view/iframe/" data-toggle="modal" href="#gen_modal" class="dropdown-item">
                                    ...
                                    <a data-url="<?php echo $route_gen; ?>article/index/view/iframe/" data-toggle="modal" href="#gen_modal" class="dropdown-item">
                                        <?php echo $lang->get('Generate all', 'console.common'); ?>
                                    </a>
                                    <a data-url="<?php echo $route_gen; ?>article/enforce/view/iframe/" data-toggle="modal" href="#gen_modal" class="dropdown-item">
                                        <?php echo $lang->get('Generate enforce', 'console.common'); ?>
                                    </a>
                                    <div class="dropdown-divider"></div>
                                    <div class="dropdown-header"><?php echo $lang->get('Category', 'console.common'); ?></div>
                                    <a data-url="<?php echo $route_gen; ?>cate/one-by-one/view/iframe/" data-toggle="modal" href="#gen_modal" class="dropdown-item">
                                    ...
                                    <a data-url="<?php echo $route_gen; ?>spec/index/view/iframe/" data-toggle="modal" href="#gen_modal" class="dropdown-item">
                                        <?php echo $lang->get('Generate list', 'console.common'); ?>
                                    </a>
                                    <div class="dropdown-divider"></div>
                                    <div class="dropdown-header"><?php echo $lang->get('Call', 'console.common'); ?></div>
                                    <a data-url="<?php echo $route_gen; ?>call/index/view/iframe/" data-toggle="modal" href="#gen_modal" class="dropdown-item">
                                        <?php echo $lang->get('Generate all', 'console.common'); ?>
                                    </a>
                                </div>
                            </div>
