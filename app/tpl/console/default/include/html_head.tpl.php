...
<head>
    ...
    if (isset($cfg['typeahead']) || isset($cfg['baigoTag'])) { ?>
        <link rel="stylesheet" href="{:DIR_STATIC}lib/typeahead/0.11.1/typeahead.css" type="text/css" rel="stylesheet">
    <?php }
    ...
    if (isset($cfg['baigoTag'])) { ?>
        <link rel="stylesheet" href="{:DIR_STATIC}lib/baigoTag/1.0.0/baigoTag.css" type="text/css" rel="stylesheet">
    <?php } ?>
