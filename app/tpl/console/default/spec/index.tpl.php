...
include($cfg['pathInclude'] . 'console_head' . GK_EXT_TPL); ?>
    ...
    <div class="d-flex justify-content-between">
        <nav class="nav mb-3">
            <a href="<?php echo $route_console; ?>spec/form/" class="nav-link">
                <span class="fas fa-plus"></span>
                <?php echo $lang->get('Add'); ?>
            </a>
        </nav>
        <form name="spec_search" id="spec_search" class="d-none d-lg-block" action="<?php echo $route_console; ?>spec/index/">
    ...
    <?php if (!empty($search['key']) || !empty($search['status']) || !empty($search['type'])) { ?>
        <div class="mb-3 text-right">
            ...
            <a href="<?php echo $route_console; ?>spec/index/" class="badge badge-danger badge-pill">
                        ...
                        <tr class="bg-manage-tr">
                            ...
                            <td>
                                ...
                                <div class="mb-2 text-wrap text-break">
                                    <a class="" href="<?php echo $route_console; ?>spec/form/id/<?php echo $value['spec_id']; ?>/">
                                        <?php echo $value['spec_name']; ?>
                                    </a>
                                </div>
                                <div class="bg-manage-menu">
                                    <div class="d-flex flex-wrap">
                                        <a href="<?php echo $route_console; ?>spec/show/id/<?php echo $value['spec_id']; ?>/" class="mr-2">
                                            <span class="fas fa-eye"></span>
                                            <?php echo $lang->get('Show'); ?>
                                        </a>
                                        <a href="<?php echo $route_console; ?>spec/form/id/<?php echo $value['spec_id']; ?>/" class="mr-2">
                                            <span class="fas fa-edit"></span>
                                            <?php echo $lang->get('Edit'); ?>
                                        </a>
                                        <a href="<?php echo $route_console; ?>spec_belong/index/id/<?php echo $value['spec_id']; ?>/" class="mr-2">
                                            <span class="fas fa-hand-pointer"></span>
                                            <?php echo $lang->get('Choose article'); ?>
                                        </a>
                                        <a href="<?php echo $route_console; ?>spec/attach/id/<?php echo $value['spec_id']; ?>/" class="mr-2">
                ...
                switch (_act) {
                    case 'delete':
                        obj_dialog.confirm('<?php echo $lang->get('Are you sure to delete?'); ?>', function(confirm_result){
                            if (confirm_result) {
                                obj_submit_list.formSubmit('<?php echo $route_console; ?>spec/delete/');
                            }
                        });
                    break;

                    default:
                        obj_submit_list.formSubmit('<?php echo $route_console; ?>spec/status/');
                    break;
                }
            }
        });
