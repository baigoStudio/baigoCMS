...
include($tpl_include . 'console_head' . GK_EXT_TPL); ?>
  ...
  <form name="gsite_list" id="gsite_list" action="<?php echo $hrefRow['status']; ?>">
            ...
            <tr class="bg-manage-tr">
              ...
              <td>
                ...
                <div class="mb-2 text-wrap text-break">
                  <a href="<?php echo $hrefRow['edit'], $value['gsite_id']; ?>">
                ...
                <div class="bg-manage-menu">
                  <div class="d-flex flex-wrap">
                    ...
                    <a href="<?php echo $hrefRow['edit'], $value['gsite_id']; ?>" class="mr-2">
...
<?php include($tpl_include . 'console_foot' . GK_EXT_TPL); ?>
  ...
  $(document).ready(function(){
    ...
    var obj_submit_list     = $('#gsite_list').baigoSubmit(opts_submit);
