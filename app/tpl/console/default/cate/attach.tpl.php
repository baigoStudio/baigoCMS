...
include($cfg['pathInclude'] . 'console_head' . GK_EXT_TPL); ?>
    ...
    <nav class="nav mb-3">
        <a href="<?php echo $route_console; ?>cate/form/id/<?php echo $cateRow['cate_id']; ?>/" class="nav-link">
    ...
    <div class="row">
        <div class="col-xl-9">
            <form name="attach_list" id="attach_list" action="<?php echo $route_console; ?>cate/cover/">
                    ...
                    <table class="table table-striped border bg-white">
                        ...
                        <tbody>
                            <?php foreach ($attachRows as $key=>$value) { ?>
                                <tr class="bg-manage-tr<?php if ($cateRow['cate_attach_id'] == $value['attach_id']) { ?> table-success<?php } ?>">
