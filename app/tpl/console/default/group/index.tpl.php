...
include($tpl_include . 'console_head' . GK_EXT_TPL); ?>
  ...
  <div class="d-flex justify-content-between">
    ...
    <form name="group_search" id="group_search" class="d-none d-lg-block" action="<?php echo $hrefRow['index']; ?>">
  ...
  <form name="group_list" id="group_list" action="<?php echo $hrefRow['status']; ?>">
            ...
            <tr class="bg-manage-tr">
              ...
              <td>
                ...
                <div class="mb-2 text-wrap text-break">
                  <a href="<?php echo $hrefRow['edit'], $value['group_id']; ?>">
                    <?php echo $value['group_name']; ?>
                  </a>
                </div>
                <div class="bg-manage-menu">
                  <div class="d-flex flex-wrap">
                    <a href="<?php echo $hrefRow['show'], $value['group_id']; ?>" class="mr-2">
                      <span class="bg-icon"><?php include($tpl_icon . 'eye' . BG_EXT_SVG); ?></span>
                      <?php echo $lang->get('Show'); ?>
                    </a>
                    <a href="<?php echo $hrefRow['edit'], $value['group_id']; ?>" class="mr-2">
...
<?php include($tpl_include . 'console_foot' . GK_EXT_TPL); ?>
  ...
  $(document).ready(function(){
    ...
    var obj_submit_list     = $('#group_list').baigoSubmit(opts_submit);
