      ...
      <div class="card mb-3">
        <div class="card-body">
          <div class="form-group">
            ...
            <div class="form-text font-weight-bolder"><?php echo $groupRow['group_name']; ?></div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="form-text font-weight-bolder"><?php echo $groupRow['group_note']; ?></div>
          </div>
        </div>
        <div class="card-footer text-right">
          <a href="<?php echo $hrefRow['edit'], $groupRow['group_id']; ?>">
      ...
      <div class="card bg-light">
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <div class="form-text font-weight-bolder"><?php $str_status = $groupRow['group_status'];
