...
include($cfg['pathInclude'] . 'gsite_head' . GK_EXT_TPL); ?>
    ...
    <form name="gsite_form" id="gsite_form" action="<?php echo $route_console; ?>gsite-step/page-lists-submit/">
...
include($cfg['pathInclude'] . 'console_foot' . GK_EXT_TPL); ?>
    ...
    $(document).ready(function(){
        ...
        $('#gsite_preview').html('<div class="embed-responsive embed-responsive-21by9"><iframe class="embed-responsive-item" scrolling="auto" src="<?php echo $route_console; ?>gsite-preview/page-lists/id/<?php echo $gsiteRow['gsite_id']; ?>/"></iframe></div>');

        $('#gsite_source').html('<div class="embed-responsive embed-responsive-21by9"><iframe class="embed-responsive-item" scrolling="auto" src="<?php echo $route_console; ?>gsite-source/page-lists/id/<?php echo $gsiteRow['gsite_id']; ?>/"></iframe></div>');
    });
    </script>
