...
include($cfg['pathInclude'] . 'gsite_head' . GK_EXT_TPL); ?>
    ...
    <form name="gsite_form" id="gsite_form" action="<?php echo $route_console; ?>gsite_step/content-submit/">
...
include($cfg['pathInclude'] . 'console_foot' . GK_EXT_TPL); ?>
            ...
            '<div class="form-group col-lg-6">' +
                '<div class="input-group">' +
                    '<div class="input-group-prepend">' +
                        '<span class="input-group-text"><?php echo $lang->get('Search'); ?></span>' +
                    '</div>' +
                    '<input type="text" name="gsite_' + type + '_replace[' + count + '][search]" id="gsite_' + type + '_replace_' + count + '" class="form-control">' +
                '</div>' +
            '</div>' +
            '<div class="form-group col-lg-6">' +
                '<div class="input-group">' +
                    '<div class="input-group-prepend">' +
                        '<span class="input-group-text"><?php echo $lang->get('Replace'); ?></span>' +
                    '</div>' +
                    '<input type="text" name="gsite_' + type + '_replace[' + count + '][replace]" id="gsite_' + type + '_replace_' + count + '" class="form-control">' +
                    '<span class="input-group-append">' +
    ...
    $(document).ready(function(){
        ...
        $('#gsite_preview').html('<div class="embed-responsive embed-responsive-21by9"><iframe class="embed-responsive-item" scrolling="auto" src="<?php echo $route_console; ?>gsite_preview/content/id/<?php echo $gsiteRow['gsite_id']; ?>/"></iframe></div>');

        $('#gsite_source').html('<div class="embed-responsive embed-responsive-21by9"><iframe class="embed-responsive-item" scrolling="auto" src="<?php echo $route_console; ?>gsite_source/content/id/<?php echo $gsiteRow['gsite_id']; ?>/"></iframe></div>');
    });
    </script>
