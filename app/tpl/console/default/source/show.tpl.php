  ...
  <div class="modal-body">
    ...
    <div class="form-group">
      ...
      <div class="form-text font-weight-bolder"><?php echo $sourceRow['source_name']; ?></div>
    </div>

    <div class="form-group">
      <label class="text-muted font-weight-light"><?php echo $lang->get('Author'); ?></label>
      <div class="form-text font-weight-bolder"><?php echo $sourceRow['source_author']; ?></div>
    </div>

    <div class="form-group">
      <label class="text-muted font-weight-light"><?php echo $lang->get('URL'); ?></label>
      <div class="form-text font-weight-bolder"><?php echo $sourceRow['source_url']; ?></div>
    </div>

    <div class="form-group">
      <label class="text-muted font-weight-light"><?php echo $lang->get('Note'); ?></label>
      <div class="form-text font-weight-bolder"><?php echo $sourceRow['source_note']; ?></div>
    </div>
  </div>
