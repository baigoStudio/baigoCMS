      ...
      <div class="col-xl-9">
        <div class="card mb-3">
          <div class="card-body">
            ...
            <div class="form-group">
              <label class="text-muted font-weight-light"><?php echo $lang->get('URL of API'); ?></label>
              <div class="form-text font-weight-bolder"><?php echo $url_api; ?></div>
            </div>
                ...
                <?php foreach ($allowRows as $key_m=>$value_m) { ?>
                  ...
                  <dd>
                    <?php foreach ($value_m['allow'] as $key_s=>$value_s) { ?>
                      <span>
                        <span class="bg-icon text-<?php echo $str_color; ?>">
