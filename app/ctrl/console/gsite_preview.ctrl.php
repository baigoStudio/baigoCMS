...
class Gsite_Preview extends Ctrl {
    ...
    function content() {
        ...
        if (!Func::isEmpty($_arr_gsiteRow['gsite_list_selector'])) {
            ...
            if (isset($_obj_dom[0]['url']) && !Func::isEmpty($_obj_dom[0]['url']) && !Func::isEmpty($_arr_gsiteRow['gsite_title_selector'])) {
    ...
    function pageLists() {
        ...
        if (!Func::isEmpty($_arr_gsiteRow['gsite_page_list_selector'])) {
            $_arr_rule = array(
                'url'   => array($_arr_gsiteRow['gsite_list_selector'], 'href'),
            );
            ...
            if (isset($_obj_dom[0]['url']) && !Func::isEmpty($_obj_dom[0]['url'])) {
    ...
    function pageContent() {
        ...
        if (!Func::isEmpty($_arr_gsiteRow['gsite_page_list_selector'])) {
            ...
            if (isset($_obj_dom[0]['url']) && !Func::isEmpty($_obj_dom[0]['url'])) {
                ...
                if (isset($_obj_domPage[0]['url']) && !Func::isEmpty($_arr_gsiteRow['gsite_page_content_selector'])) {
