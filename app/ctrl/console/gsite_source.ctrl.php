...
class Gsite_Source extends Ctrl {
    ...
    function form() {
        ...
        return $this->fetch('gsite_source' . DS . 'source');
    }
    ...
    function content() {
        ...
        if (!Func::isEmpty($this->gsiteRow['gsite_list_selector'])) {
            $_arr_rule = array(
    ...
    function pageContent() {
        ...
        if (!Func::isEmpty($this->gsiteRow['gsite_list_selector']) && !Func::isEmpty($this->gsiteRow['gsite_page_list_selector'])) {
            $_arr_rule = array(
                'url' => array($this->gsiteRow['gsite_list_selector'], 'href'),
            );
            ...
            if (isset($_obj_dom[0]['url']) && !Func::isEmpty($_obj_dom[0]['url'])) {
                ...
                if (isset($_obj_domPage[0]['url']) && !Func::isEmpty($_obj_domPage[0]['url'])) {
