...
class Opt extends Ctrl {
  ...
  protected function c_init($param = array()) {
    ...
    $_arr_hrefRow = array(
      ...
      'article-clear'         => $this->url['route_console'] . 'article/clear/',
      'cate-belong-clear'     => $this->url['route_console'] . 'cate_belong/clear/',
      'spec-belong-clear'     => $this->url['route_console'] . 'spec_belong/clear/',
      'tag-belong-clear'      => $this->url['route_console'] . 'tag_belong/clear/',
      'album-belong-clear'    => $this->url['route_console'] . 'album_belong/clear/',
      'article-content-clear' => $this->url['route_console'] . 'article_content/clear/',
      'article-custom-clear'  => $this->url['route_console'] . 'article_custom/clear/',
    );
  ...
  public function form() {
    ...
    foreach ($_arr_consoleAct as $_key=>&$_value) {
      ...
      $_value['lang_replace']['visit_default'] = $this->obj_request->root(true) . 'index.php/aritcle/' . date('Y') . '/' . date('m') . '/123/';
      $_value['lang_replace']['visit_pstatic'] = $this->obj_request->root(true) . 'aritcle/' . date('Y') . '/' . date('m') . '/123/';
      $_value['lang_replace']['visit_static']  = $this->obj_request->root(true) . 'aritcle/' . date('Y') . '/' . date('m') . '/123.html';
    }
