...
return array(
  ...
  'Only install baigo CMS (Manually set the baigo SSO)' => '仅安装 baigo CMS（手动设置 baigo SSO）',
  'Disabled during full installation'                 => '全新安装时禁用',
  'baigo SSO is an Single Sign On system, baigo CMS dependent on this system.' => 'baigo SSO 是一个单点登录系统，baigo CMS 依赖于此系统。',
